...
class DeptDesainProof extends CI_Controller {
    ...
    function index_get(){
        ...
        if(empty( $this->input->get('key',true) )){
            ...
            $get = $this->db->like('mst_karyawan.kode_unit','35B','after')->get('mst_karyawan')->result_array();
            echo json_encode([
                'status'=>true,
                'message'=>'Data Karyawan Departemen Desain dan Proof',
                'data'=>$get
            ]);
        }
    }
