    ...
    function index_post()
    {
        ...
        if (empty($id)) {
            ...
            if ($lap == []) {
                ...
                if ($lap['akta_kelahiran'] != null && $lap['akta_kelahiran'] != '') {
                    $akta_kelahiran = base_url('uploads/pelaporan/anak_tertanggung/akta_kelahiran/').$lap['akta_kelahiran'];
                    $lap['akta_kelahiran'] = $akta_kelahiran;
                }

                if ($lap['surat_keterangan'] != null && $lap['surat_keterangan'] != '') {
                    $surat_keterangan = base_url('uploads/pelaporan/anak_tertanggung/surat_keterangan/').$lap['surat_keterangan'];
                    $lap['surat_keterangan'] = $surat_keterangan;
                }

                if ($lap['kk'] != null && $lap['kk'] != '') {
                    $kk = base_url('uploads/pelaporan/anak_tertanggung/kk/').$lap['kk'];
                    $lap['kk'] = $kk;
                }
