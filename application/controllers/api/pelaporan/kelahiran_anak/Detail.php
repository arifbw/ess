        ...
        if (empty($id)) {
            ...
            if ($lap == []) {
                ...
                if ($lap['akta_kelahiran'] != null && $lap['akta_kelahiran'] != '') {
                    $akta_kelahiran = base_url('uploads/pelaporan/kelahiran_anak/akta_kelahiran/').$lap['akta_kelahiran'];
                    $lap['akta_kelahiran'] = $akta_kelahiran;
                }

                if ($lap['dokumen_lain'] != null && $lap['dokumen_lain'] != '') {
                    $dokumen_lain = base_url('uploads/pelaporan/kelahiran_anak/dokumen_lain/').$lap['dokumen_lain'];
