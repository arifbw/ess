...
class Approve extends MY_Controller {
    ...
    function index_post(){
        if(empty($this->post('id'))){ 
        ...
        } else if(empty($this->post('approval_status'))){ # untuk approval atasan valuenya 3 atau 4
            $this->response([
                'status'=>false,
            ...
            $this->db->where('id', $this->post('id'))->update('ess_laporan_suami_tertanggung',$data_insert);
