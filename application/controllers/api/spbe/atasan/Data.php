...
class Data extends Group_Controller {
    ...
    function index_get(){
        ...
        $this->db
            ...
            ->where('approval_atasan_np',$this->data_karyawan->np_karyawan)
            // ->where('approval_atasan_status IS NULL',null,false)
            ->from('ess_permohonan_spbe')
        ...
        $this->response([
            'status'=>true,
            'message'=>'Data Permohonan SPBE menunggu persetujuan',
            'data'=>$data
