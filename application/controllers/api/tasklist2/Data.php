...
class Data extends MY_Controller {
    ...
    function index_post(){
        ...
        $this->response([
            'status'=>false,
            'message'=>"Input tasklist di fitur ini sudah ditutup. Silakan update applikasi Anda ke versi terbaru.",
            'data'=>[]
        ], MY_Controller::HTTP_BAD_REQUEST);
        /*try {
            if(empty($this->post('tanggal'))){
                ...
                $data_insert['kode_unit_atasan'] = $this->post('kode_unit_atasan');
                $data_insert['nama_jabatan_atasan'] = $this->post('nama_jabatan_atasan');
