...
class Detail extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/info/listrik/';
		$this->folder_model = 'faskar/info/listrik/';
		$this->folder_controller = 'faskar/info/listrik/';
		...
		$this->data['judul'] = "Info Listrik dari PLN";
