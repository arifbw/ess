...
class Header extends CI_Controller {
	...
	public function tabel_header() {
		$this->load->model("faskar/persetujuan/internet/M_tabel_internet_header");
	...
	function approval(){
		...
		$this->load->view('faskar/persetujuan/internet/approval', [
			'header'=>$header
		]);
	}
	...
	function save_approval(){
		...
		$this->db->where('id',$id)->update('ess_faskar_internet_header',$data_insert);
