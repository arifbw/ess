...
class Header extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/persetujuan/listrik/';
		$this->folder_model = 'faskar/listrik/';
		$this->folder_controller = 'faskar/persetujuan/listrik/';
		
		$this->akses = array();
		
		$this->data["is_with_sidebar"] = true;
		
		$this->data['judul'] = "Persetujuan Listrik";
	...
	public function tabel_header() {
		$this->load->model("faskar/persetujuan/listrik/M_tabel_listrik_header");
	...
	function approval(){
		...
		$this->load->view('faskar/persetujuan/listrik/approval', [
			'header'=>$header
		]);
	}
	...
	function save_approval(){
		...
		$this->db->where('id',$id)->update('ess_faskar_listrik_header',$data_insert);
