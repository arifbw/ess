...
class Header extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/persetujuan/ponsel/';
		$this->folder_model = 'faskar/ponsel/';
		$this->folder_controller = 'faskar/persetujuan/ponsel/';
		
		$this->akses = array();
		
		$this->data["is_with_sidebar"] = true;
		
		$this->data['judul'] = "Persetujuan Pulsa";
	...
	public function tabel_header() {
		$this->load->model("faskar/persetujuan/ponsel/M_tabel_ponsel_header");
	...
	function approval(){
		...
		$this->load->view('faskar/persetujuan/ponsel/approval', [
			'header'=>$header
		]);
	}
