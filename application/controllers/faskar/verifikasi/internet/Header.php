...
class Header extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/verifikasi/internet/';
		$this->folder_model = 'faskar/internet/';
		$this->folder_controller = 'faskar/verifikasi/internet/';
		
		$this->akses = array();
		
		$this->data["is_with_sidebar"] = true;
		
		$this->data['judul'] = "Verifikasi Internet";
	...
	public function tabel_header() {
		$this->load->model("faskar/verifikasi/internet/M_tabel_internet_header");
	...
	function approval(){
		...
		$this->load->view('faskar/verifikasi/internet/approval', [
			'header'=>$header
		]);
	}
