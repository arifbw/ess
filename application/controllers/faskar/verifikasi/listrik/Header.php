...
class Header extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/verifikasi/listrik/';
		$this->folder_model = 'faskar/listrik/';
		$this->folder_controller = 'faskar/verifikasi/listrik/';
		
		$this->akses = array();
		
		$this->data["is_with_sidebar"] = true;
		
		$this->data['judul'] = "Verifikasi Listrik";
	...
	public function tabel_header() {
		$this->load->model("faskar/verifikasi/listrik/M_tabel_listrik_header");
	...
	function approval(){
		...
		$this->load->view('faskar/verifikasi/listrik/approval', [
			'header'=>$header
		]);
	}
