...
class Header extends CI_Controller {
	public function __construct(){
		...
		$this->folder_view = 'faskar/verifikasi/pam/';
		$this->folder_model = 'faskar/pam/';
		$this->folder_controller = 'faskar/verifikasi/pam/';
		
		$this->akses = array();
		
		$this->data["is_with_sidebar"] = true;
		
		$this->data['judul'] = "Verifikasi PAM";
	...
	public function tabel_header() {
		$this->load->model("faskar/verifikasi/pam/M_tabel_pam_header");
	...
	function approval(){
		...
		$this->load->view('faskar/verifikasi/pam/approval', [
			'header'=>$header
		]);
	}
