<?php
	...
	class Hut_pendaftaran extends CI_Controller {
		public function __construct(){
			...
			$this->folder_view = 'hut_peruri/';
			$this->folder_model = 'hut_peruri/';
			$this->folder_controller = 'hut_peruri/';
			...
			$this->load->model($this->folder_model."m_pendaftaran");
		
			$this->data["is_with_sidebar"] = true;
								
			$this->data['judul'] = "HUT Pendaftaran";
		...
		{			
			...
			$this->data['content'] = $this->folder_view."hut_pendaftaran";
		...
		public function tabel_hut_pendaftaran()
		{		
			$this->load->model($this->folder_model."/M_tabel_hut_pendaftaran");
			...
			$list = $this->M_tabel_hut_pendaftaran->get_datatables($var);
			$data = array();
			$no = $_POST['start'];
			foreach ($list as $tampil) {
				...
				$row[] = $tampil->nama;		
				$row[] = tanggal($tampil->dws_tanggal);	
			...
			foreach ($get_data as $tampil) {
				...
				if($tampil->id_cuti) {
					if($tampil_keterangan=='')
						...
						$tampil_keterangan = $tampil_keterangan."<br><br>".'Cuti';
				}
