<?php
	...
	class Sto extends CI_Controller {
		public function __construct(){
			...
			$this->load->model($this->folder_model."m_sto");
		...
		public function tampil($id_menu=null){
			...
			if($this->akses["lihat"]){				
				$data["daftar_menu"] = $this->m_sto->daftar_pengaturan_menu($id_menu);
				$data["pilihan_modul"] = $this->m_sto->daftar_pengaturan_menu($id_menu);
			}
            //echo json_encode($data["daftar_menu"]); exit();
			$this->load->view($this->folder_view."sto",$data);
		}
	...
	/* Location: ./application/controllers/master_data/ajax/isi_menu.php */