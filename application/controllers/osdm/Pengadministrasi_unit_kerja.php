<?php
	...
	class Pengadministrasi_unit_kerja extends CI_Controller {
		public function __construct(){
			...
			$this->load->model($this->folder_model."m_pengadministrasi_unit_kerja");
		...
		public function index(){
			...
			$this->data['content'] = $this->folder_view."pengadministrasi_unit_kerja";
			...
			if($this->akses["lihat"]){
				...
				$this->data["daftar_pengguna_pengadministrasi"] = $this->m_pengadministrasi_unit_kerja->daftar_pengguna_pengadministrasi($arr_id_grup_pengguna);
