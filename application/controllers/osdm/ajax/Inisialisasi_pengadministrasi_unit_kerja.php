<?php
	...
	class Inisialisasi_pengadministrasi_unit_kerja extends CI_Controller {
		...
		public function pengadministrasi($username){
			...
			$data["cek_pengadministrasi"] = $this->m_pengguna_grup_pengguna->cek_grup_pengguna($id_pengguna,$id_grup_pengadministrasi);
			...
			$this->load->view($this->folder_view."inisialisasi_pengadministrasi_unit_kerja",$data);
		}
	}
