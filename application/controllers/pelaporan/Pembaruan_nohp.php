...
class Pembaruan_nohp extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('pelaporan/M_perubahan_nohp');
        ...
        $this->data['judul'] = "Pembaruan Nomor HP";
    ...
    public function index()
    {
        ...
        $this->data['content'] 					= $this->folder_view."lihat_pembaruan_nohp";
    ...
    public function tabel_laporan_perubahan_nohp() {
        if($this->akses["lihat"]) {
            ...
            $list = $this->M_perubahan_nohp->get_datatables();
            $data = array();
            $no = $_POST['start'];
            ...
            $output = array(
                "draw" => $_POST['draw'],
                "recordsTotal" => $this->M_perubahan_nohp->count_all(),
                "recordsFiltered" => $this->M_perubahan_nohp->count_filtered(),
                "data" => $data,
            );
    ...
    public function action_insert() {
        ...
        $this->form_validation->set_rules('nohp_lama', 'nohp Lama', 'required');
        $this->form_validation->set_rules('nohp_baru', 'nohp Baru', 'required');
