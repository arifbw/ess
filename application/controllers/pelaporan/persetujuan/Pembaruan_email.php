...
class Pembaruan_email extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('pelaporan/M_persetujuan_perubahan_email');
        ...
        $this->data['judul'] = "Persetujuan Pembaruan Email";
    ...
    public function index()
    {
        ...
        $this->data['content'] 					= $this->folder_view."pembaruan_email";
    ...
    public function tabel_laporan_perubahan_email() {
        ...
        if($this->akses["CRUD"]) {
            $this->load->model($this->folder_model . "M_persetujuan_perubahan_email");
    
            $list = $this->M_persetujuan_perubahan_email->get_datatables();
            $data = array();
            $no = $_POST['start'];
            ...
            $output = array(
                "draw" => $_POST['draw'],
                "recordsTotal" => $this->M_persetujuan_perubahan_email->count_all(),
                "recordsFiltered" => $this->M_persetujuan_perubahan_email->count_filtered(),
                "data" => $data,
            );
    ...
    public function approve($id) {
        if($this->akses["CRUD"]) {
            ...
            // Menghapus data dengan ID yang diberikan
            $result = $this->M_persetujuan_perubahan_email->approve($id);
    ...
    public function tolak($id) {
        if($this->akses["CRUD"]) {
            ...
            // Menghapus data dengan ID yang diberikan
            $result = $this->M_persetujuan_perubahan_email->tolak($id);
    ...
    public function action_insert() {
        // Memuat model yang diperlukan
        $this->load->model($this->folder_model . "M_pengajuan_perubahan_email");
