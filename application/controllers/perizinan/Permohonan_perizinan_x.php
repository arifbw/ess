<?php
	...
	class permohonan_perizinan_x extends CI_Controller {
...
//			}
        ...
        public function cetak() {
            ...
            if (in_array('all_karyawan', $this->input->post('np_karyawan'))) {
                $this->load->model("perizinan/M_persetujuan_keamanan");
                $query_result = $this->M_persetujuan_keamanan->select_daftar_karyawan();
                $array_daftar_karyawan = $query_result->result_array();
                $set['np_karyawan'] = array_column($array_daftar_karyawan, 'no_pokok');
            } else {
                $set['np_karyawan'] = $this->input->post('np_karyawan');
            }

            $set['range_tgl'] = $this->input->post('range_tgl');
