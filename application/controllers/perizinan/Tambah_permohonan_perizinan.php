...
class Tambah_permohonan_perizinan extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['content'] 					= $this->folder_view."tambah_permohonan_perizinan";
	...
	function action_insert_perizinan(){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect(base_url('perizinan/permohonan_perizinan'), 'refresh');
		} else {
			$data_insert = [];
			...
			if($submit){
				...
				if($np_karyawan=='' || $np_karyawan==null){
					...
					redirect(base_url($this->folder_controller.'permohonan_perizinan'), 'refresh');
