...
class Contribution extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['content'] = $this->folder_view . "contribution";
        ...
        if ($this->akses["tambah"]) {
            ...
            if (($this->input->post('edit_id', true) == '' && $_FILES['dokumen']['tmp_name'] == '') || $this->form_validation->run() == FALSE) {
                ...
                if ($submit) {
                    ...
                    $upload_path = './uploads/contribution/dokumen';
                    ...
                    if ($error == "") {
                        ...
                        if ($this->db->affected_rows() > 0) {
                            if ($this->input->post('edit_id', true) != '') {
                                if (@$dokumen)
                                    unlink('./uploads/contribution/dokumen/' . $data_lama->dokumen);
                        ...
                        redirect(base_url($this->folder_controller . 'contribution'));
                    } else {
    ...
    public function hapus($id = null, $np = null)
    {
        ...
        if (@$id != null && @$np != null) {
            ...
            if ($this->db->affected_rows() > 0) {
                $return["status"] = true;
                if (@$get['dokumen'])
                    unlink('./uploads/contribution/dokumen/' . $get['dokumen']);
                $log_data_lama = "";
    ...
    public function view_detail()
    {
        ...
        $this->load->view($this->folder_view . "detail_contribution", $data);
    }
