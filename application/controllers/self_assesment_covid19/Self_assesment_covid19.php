<?php
	...
	class Self_assesment_covid19 extends CI_Controller {
		...
		public function cetak_beresiko() {
	        ...
	        //nama file
	        header("Content-Disposition: attachment; filename=Karyawan Beresiko.xlsx");
			...
			foreach ($query->result_array() as $data) 
			{
				...
				$excel->getActiveSheet()->setCellValueExplicit('B'.$awal, date('d-m-Y', strtotime($tampil->dws_tanggal)), PHPExcel_Cell_DataType::TYPE_STRING);
