...
class Pengecekan_keluar_petugas_pamsiknilmat extends CI_Controller {
	public function __construct(){
		...
		$this->data['judul'] = "Pemeriksaan SPBE Keluar oleh Petugas Pamsiknilmat";
	...
	function simpan_approval(){
		...
		if( $spbe->approval_pengamanan_keluar=='1' && $pengecek1_status=='2' ){
			$status = false;
			...
			$data_insert = [
				...
				'pengecek1_status'=>$this->input->post('pengecek1_status'),
				'pengecek1_keterangan'=>$this->input->post('pengecek1_status')=='1' ? null:$this->input->post('pengecek1_keterangan'),
