...
class M_isi_menu extends CI_Model {
	...
	public function daftar_pengaturan_menu($id_menu){
		$data = $this->db->select("i.*")
						 ...
						 ->join($this->table." p", "i.id_master_menu=p.id_master_menu AND i.urutan_induk=p.urutan_induk AND i.urutan > p.urutan", "left")
						 ->join($this->table." n", "i.id_master_menu=n.id_master_menu AND i.urutan_induk=n.urutan_induk AND i.urutan < n.urutan", "left")
