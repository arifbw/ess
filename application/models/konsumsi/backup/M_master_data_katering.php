...
class M_master_data_katering extends CI_Model {
	...
	public function daftar_katering($nama=null){
	...
	public function daftar_katering_new($id){
	...
	public function cek_hasil_daftar_katering($nama,$status){
		$data = $this->db->from($this->table)
						 ->where('nama',$nama)
						 ->where('status',$status)
						 ->get();
	...
	public function cek_tambah_daftar_katering($nama){
		$data = $this->db->from($this->table)
						 ->where('nama',$nama)
						 ->get();
	...
	//public function cek_ubah_daftar_katering($nama,$nama_ubah){
	public function cek_ubah_daftar_katering($data_update){
