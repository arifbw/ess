...
class M_pamlek_to_ess extends CI_Model {
			...
			SELECT
				IFNULL(
					(
						...
						AND tapping_time > '$tapping_out_kemarin' /*Tapping out kemarin*/
	...
	public function search_tapping_out($tanggal_dws, $np_karyawan,$tabel_sekarang,$tabel_besok,$dws_in_sekarang,$dws_in_besok)
	{
		$tabel_sekarang=str_replace("-","_",$tabel_sekarang);
