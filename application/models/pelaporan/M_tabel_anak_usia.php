...
class M_tabel_anak_usia extends CI_Model {
    
	//var $table = "pamlek_data_2018_11";
	var $column_order = array(null, 'np_karyawan', 'nama_anak', 'tanggal_lahir_anak', 'jenis_kelamin_anak', 'keterangan', 'tempat_lahir_anak', 'anak_ke'); //set column field database for datatable orderable
	var $column_search = array('np_karyawan','nama_karyawan','nama_anak','jenis_kelamin_anak','tanggal_lahir_anak','keterangan', 'tempat_lahir_anak', 'anak_ke', 'nama_sekolah', 'kelas'); //set column field database for datatable searchable 
