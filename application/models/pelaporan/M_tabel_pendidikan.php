...
class M_tabel_pendidikan extends CI_Model {
    
	//var $table = "pamlek_data_2018_11";
	var $column_order = array(null, 'np_karyawan', 'fakultas', 'jurusan', 'perguruan_tinggi', 'keterangan', null, null); //set column field database for datatable orderable
	var $column_search = array('np_karyawan','nama_karyawan','fakultas','perguruan_tinggi','jenjang','jurusan','keterangan'); //set column field database for datatable searchable 
	var $order = array('a.approval_status', 'asc'); // default order 
