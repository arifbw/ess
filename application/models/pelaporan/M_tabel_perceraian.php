...
class M_tabel_perceraian extends CI_Model {
    
	//var $table = "pamlek_data_2018_11";
	var $column_order = array(null, 'np_karyawan', 'nama_pasangan', 'tanggal_perceraian', 'tempat_perceraian', 'keterangan', null, null); //set column field database for datatable orderable
	var $column_search = array('np_karyawan','nama_karyawan','nama_pasangan','tempat_perceraian','tanggal_perceraian','keterangan'); //set column field database for datatable searchable 
