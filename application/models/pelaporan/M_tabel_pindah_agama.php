...
class M_tabel_pindah_agama extends CI_Model {
    
	//var $table = "pamlek_data_2018_11";
	var $column_order = array(null, 'np_karyawan', 'agama_lama', 'tanggal_pindah', 'agama_baru', 'keterangan', null, null); //set column field database for datatable orderable
	var $column_search = array('np_karyawan','nama_karyawan','agama_lama','agama_baru','tanggal_pindah','keterangan'); //set column field database for datatable searchable 
