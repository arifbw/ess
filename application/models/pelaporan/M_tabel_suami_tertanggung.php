...
class M_tabel_suami_tertanggung extends CI_Model {
    
	//var $table = "pamlek_data_2018_11";
	var $column_order = array(null, 'np_karyawan', 'nama_suami', 'tanggal_lahir_suami', 'status_pekerjaan','nama_instansi', 'keterangan', 'tempat_lahir_suami', 'suami_ke', null, null); //set column field database for datatable orderable
	var $column_search = array('np_karyawan','nama_karyawan','nama_suami','status_pekerjaan','nama_instansi','tanggal_lahir_suami','keterangan', 'tempat_lahir_suami', 'suami_ke'); //set column field database for datatable searchable 
	...
	private function _get_datatables_query($var=null, $get_tbl=null) {
        $this->db->select("*")->from("ess_laporan_suami_tertanggung a");
