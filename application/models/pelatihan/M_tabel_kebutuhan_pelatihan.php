...
class M_tabel_kebutuhan_pelatihan extends CI_Model {

    var $table = 'ess_diklat_kebutuhan_pelatihan';
    var $column_order = array(null, 'ess_diklat_kebutuhan_pelatihan.np_karyawan','ess_diklat_kebutuhan_pelatihan.nama', null, null, null, null, null, null); //set column field database for datatable orderable
    var $column_search = array('ess_diklat_kebutuhan_pelatihan.np_karyawan','ess_diklat_kebutuhan_pelatihan.nama','ess_diklat_kebutuhan_pelatihan.kode_pelatihan','ess_diklat_kebutuhan_pelatihan.pelatihan','ess_diklat_kebutuhan_pelatihan.vendor'); //set column field database for datatable searchable 
    // var $order = array("ess_diklat_kebutuhan_pelatihan.id_kategori_pelatihan" => "asc", "ess_diklat_kebutuhan_pelatihan.id_pelatihan" => "asc" ,"ess_diklat_kebutuhan_pelatihan.created_at" => "desc"); // default order 
    var $order = array("created_at" => "desc"); // default order 
    // var $order = array("ess_diklat_kebutuhan_pelatihan.np_karyawan" => "asc"); // default order 

    public function __construct(){
        parent::__construct();
    }

    private function _get_datatables_query($month=null,$filter='all',$np_karyawan=null,$id_kategori_pelatihan=null,$id_pelatihan=null)
    { 
        ...
        $this->db->select('ess_diklat_kebutuhan_pelatihan.updated_at');
        //$this->db->select('mst_diklat_pelatihan.nama_pelatihan');
        ...
        if(@$np_karyawan!=''){
            $this->db->where("ess_diklat_kebutuhan_pelatihan.np_karyawan", $np_karyawan);
        }

        if(@$id_kategori_pelatihan!=''){
            $this->db->where("ess_diklat_kebutuhan_pelatihan.id_kategori_pelatihan", $id_kategori_pelatihan);
        }

        if(@$id_pelatihan!=''){
            $this->db->where("ess_diklat_kebutuhan_pelatihan.id_pelatihan", $id_pelatihan);
        }
    ...
    function get_datatables($month=null,$filter='all',$np_karyawan=null,$id_kategori_pelatihan=null,$id_pelatihan=null)
    {
        $this->_get_datatables_query($month,$filter,$np_karyawan,$id_kategori_pelatihan,$id_pelatihan);
    ...
    function count_filtered($month=null,$filter='all',$np_karyawan=null,$id_kategori_pelatihan=null,$id_pelatihan=null)
    {
        $this->_get_datatables_query($month,$filter,$np_karyawan,$id_kategori_pelatihan,$id_pelatihan);
        $query = $this->db->get();
    ...
    public function count_all($month=null,$filter='all',$np_karyawan=null,$id_kategori_pelatihan=null,$id_pelatihan=null)
    {
        $this->db->from($this->table);
        $this->db->join('mst_diklat_pelatihan', 'mst_diklat_pelatihan.id = ess_diklat_kebutuhan_pelatihan.id_pelatihan', 'left');
