		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				?>
						...
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_kelompok_modul">
								<thead>
									<tr>
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_kelompok_modul);$i++){
											...
											echo "<tr class='$class'>";
												echo "<td>".$daftar_kelompok_modul[$i]["nama"]."</td>";
												echo "<td>".$daftar_kelompok_modul[$i]["keterangan"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_kelompok_modul[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_kelompok_modul[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													...
													if($akses["lihat log"]){
														echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_kelompok_modul[$i]["nama"]."\",".$daftar_kelompok_modul[$i]["id"].")'>Lihat Log</button>";
													}
													echo "</td>";
												}
											echo "</tr>";
