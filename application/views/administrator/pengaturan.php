		...
		<div id="page-wrapper">
			<div class="container-fluid">
											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="isi" value="<?php echo $isi;?>" placeholder="Isi">
														</div>
														<div id="warning_isi" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_pengaturan">
								<thead>
									<tr>
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_pengaturan);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												echo "<td>".$daftar_pengaturan[$i]["nama"]."</td>";
												echo "<td>".$daftar_pengaturan[$i]["isi"]."</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														...
														if($akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_pengaturan[$i]["nama"]."\",".$daftar_pengaturan[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-4">
														...
														<input class="form-control" name="isi_ubah" value="" placeholder="isi">
													</div>
