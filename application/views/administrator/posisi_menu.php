											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="shortcode" value="<?php echo $shortcode;?>" placeholder="Shortcode">
														</div>
														<div id="warning_shortcode" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
											...
											echo "<tr class='$class'>";
												...
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														...
														if($akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_posisi_menu[$i]["nama"]."\",".$daftar_posisi_menu[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
