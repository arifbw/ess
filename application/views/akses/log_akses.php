				...
				<table width="100%" class="table table-striped table-bordered table-hover" id="log_akses_table">
					<thead>
						<tr>
							...
							<th class="text-center" style="width: 10%">NP/Username</th>
							<th class="text-center" style="width: 10%">Modul</th>
							<th class="text-center" style="width: 10%">Keterangan</th>
							<th class="text-center" style="width: 10%">Akses Melalui</th>
							<th class="text-center" style="width: 15%">IP Address</th>
							<th class="text-center" style="width: 15%">Waktu Akses</th>
							<th class="text-center" style="width: 15%">User Agent</th>
...
<script src="<?= base_url('asset/js/akses/log_akses/index.js')?>"></script>
