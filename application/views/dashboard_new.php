...
<style type="text/css">
	...
	.panel-violet{
		background-color: #9d8fb8 !important;
		color: #fff !important;
	}
	.panel-violet > a{
		color: #9d8fb8 !important;
	}
	...
	<div class="row">
		<div class="col-lg-9 col-md-6">
			<div class="form-group">
				...
				<div class="col-lg-1 col-md-6 col-sm-6" id="filter_bulan">
					<label>Bulan</label>
				</div>
...
<script type="text/javascript">
	function filter_np_karyawan(){
        ...
        var url = "<?php echo base_url();?>home_new/filter_np_karyawan/"+np_karyawan; // get selected value
	...
	function filter_tahun_bulan(){
        ...
        var url = "<?php echo base_url();?>home_new/filter_tahun_bulan/"+tahun_bulan; // get selected value
        if (url) { // require a URL
            window.location = url; // redirect
        }
        return false;
