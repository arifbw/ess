...
<script>
    ...
    var pemakaian = '<?= $header['pemakaian']?>';
    var plafon = '<?= $header['plafon']?>';
    var roaming = '<?= $header['roaming_ln']?>';
    ...
    $(document).ready(function() {
		...
		$('#pemakaian').html(`Rp ${parseInt(pemakaian).toLocaleString()}`);
		$('#plafon').html(`Rp ${parseInt(plafon).toLocaleString()}`);
		$('#roaming').html(`Rp ${parseInt(roaming).toLocaleString()}`);
