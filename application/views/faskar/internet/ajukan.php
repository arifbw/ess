...
<script>
    ...
    $(document).ready(function() {
		$('#modal-title-ajukan').html(`Ajukan ke Atasan: Pemakaian Internet ${header_lokasi} Bulan ${moment(header_pemakaian_bulan).format('MMMM YYYY')}`);
    ...
    function save(){
        ...
        if (result) {
            $.ajax({
                type: "POST",
                url: `<?= base_url('faskar/internet/header/save_ajukan')?>`,
                data: allData,
                dataType: 'JSON',
