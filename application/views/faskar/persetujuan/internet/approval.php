...
<script>
    ...
    $(document).ready(function() {
		$('#modal-title-approval').html(`Persetujuan Pemakaian Internet ${header_layanan} ${header_lokasi} Bulan ${moment(header_pemakaian_bulan).format('MMMM YYYY')}`);
	});
    ...
    function save(){
		...
		if (result) {
            $.ajax({
                type: "POST",
                url: `<?= base_url('faskar/persetujuan/internet/header/save_approval')?>`,
