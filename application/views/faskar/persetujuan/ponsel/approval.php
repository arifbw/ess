...
<script>
    ...
    $(document).ready(function() {
		$('#modal-title-approval').html(`Persetujuan Pemakaian Ponsel Bulan ${moment(header_pemakaian_bulan).format('MMMM YYYY')}`);
	});
    ...
    function save(){
		...
		if (result) {
            $.ajax({
                type: "POST",
                url: `<?= base_url('faskar/persetujuan/ponsel/header/save_approval')?>`,
