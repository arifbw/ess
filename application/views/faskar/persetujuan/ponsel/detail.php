	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<a href="<?= base_url('faskar/persetujuan/ponsel/header')?>" class="btn btn-default btn-md"><i class="fa fa-arrow-left"></i> Kembali</a>
			</div>
		</div>
		<br>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#page-header-title').html(`Pemakaian Ponsel Bulan ${moment(header_pemakaian_bulan).format('MMMM YYYY')}`);
		Promise.all([
	...
	const tableServerside = async () => {
		...
		table = $('#tabel_ponsel').DataTable({ 
			...
			"ordering": false,
			"ajax": {				
				"url"	: "<?php echo site_url("faskar/persetujuan/ponsel/detail/tabel_ponsel")?>",					 
				"type"	: "POST",
