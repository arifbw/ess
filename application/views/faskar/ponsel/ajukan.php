...
<script>
    ...
    $(document).ready(function() {
		$('#modal-title-ajukan').html(`Ajukan ke Atasan: Pemakaian Pulsa Bulan ${moment(header_pemakaian_bulan).format('MMMM YYYY')}`);
    ...
    function save(){
        ...
        if (result) {
            $.ajax({
                type: "POST",
                url: `<?= base_url('faskar/ponsel/header/save_ajukan')?>`,
                data: allData,
                dataType: 'JSON',
