	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				<a href="<?= base_url('faskar/verifikasi/ponsel/header')?>" class="btn btn-default btn-md"><i class="fa fa-arrow-left"></i> Kembali</a>
			</div>
		</div>
		<br>
...
<script type="text/javascript">
	...
	const tableServerside = async () => {
		...
		table = $('#tabel_ponsel').DataTable({ 
			...
			"ordering": false,
			"ajax": {				
				"url"	: "<?php echo site_url("faskar/verifikasi/ponsel/detail/tabel_ponsel")?>",					 
				"type"	: "POST",
