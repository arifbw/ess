		...
		<div id="page-wrapper">
		    <div class="container-fluid">
		        ...
		        <div class="form-group">
		            <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" id='unit' name='unit' onchange="refresh_table_serverside()" style="width: 200px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" id='konfirmasi' name='konfirmasi' onchange="refresh_table_serverside()" style="width: 200px;">
		                        ...
		                        <!-- <option value='nilai'>Pemesan Menilai Driver</option> -->
		        ...
		        <div class="form-group">
		            <div class="row">
		                <table width="100%" class="table table-striped table-bordered table-hover" id="tabel_konfirmasi_pemesanan">
		                    <thead>
		                        <tr>
		...
		<script type="text/javascript">
		    ...
		    $(document).ready(function() {
		        ...
		        $('.select2').select2();
		        $('#tabel_konfirmasi_pemesanan').DataTable().destroy();
		        table_serverside();
		    });
		...
		<script>
		    function table_serverside() {
		        ...
		        //datatables
		        table = $('#tabel_konfirmasi_pemesanan').DataTable({
		            "iDisplayLength": 10,
		            "language": {
		            ...
		            "ajax": {
		                "url": "<?php echo site_url("food_n_go/kendaraan/konfirmasi_pemesanan/tabel_konfirmasi_pemesanan/")?>" + unit + '/' + konfirmasi + '/' + bulan_tahun,
		                "type": "POST"
		            },
            ...
            function show_detail(input) {
		        var url = '<?= base_url('food_n_go/kendaraan/umum/show_detail/')?>' + input.dataset.id;
            ...
            function show_biaya(input){
                var url = '<?= base_url('food_n_go/kendaraan/konfirmasi_pemesanan/show_biaya_statis/')?>'+input.dataset.kode;
		...
		<?php 
		if(@$akses["ubah"]){ ?>
            function update_konfirmasi(input) {
		        var url = '<?= base_url('food_n_go/kendaraan/konfirmasi_pemesanan/update_konfirmasi/')?>' + input.dataset.id;
		        $("#modal-content-detail").html('Loading...');
		        $("#modal_detail").modal('show');
		        $.get(url).done(function(data) {
		            $("#modal-content-detail").html(data);
		...
		<?php } ?>
            ...
            function selesaikan(input){
                ...
                if (result) {
                    $.when(
                        $.ajax({
                            url: "<?php echo base_url('food_n_go/kendaraan/umum/selesaikan_pesanan');?>",
                            type: "POST",
                            dataType: "json",
            ...
            function batalkan(input){
                ...
                var result = confirm("Betalkan pesanan ini?");
                if (result) {
                    $.when(
                        $.ajax({
                            url: "<?php echo base_url('food_n_go/kendaraan/umum/batalkan_pesanan');?>",
                            type: "POST",
                            dataType: "json",
                            data: {kode: input.dataset.kode},
                            success: function(response){
