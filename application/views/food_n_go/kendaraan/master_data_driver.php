											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div id="warning_uraian" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
													<div class="form-group">
									...
									<?php
										for($i=0;$i<count($daftar_jenis_kendaraan);$i++){
											...
											echo "<tr class='$class'>";
												...
												echo "<td>".$daftar_jenis_kendaraan[$i]["jenis_sim"]."</td>";
										...
										<div class="modal-body">
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														...
														<input class="form-control" name="nama_ubah" value="" placeholder="Nama Kendaraan">
													</div>
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														<input type="hidden" name="nopol" value="">
														<input class="form-control" name="nopol_ubah" value="" placeholder="Nomor Polisi">
													</div>
