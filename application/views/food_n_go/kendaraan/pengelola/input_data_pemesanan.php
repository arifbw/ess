		...
		<div id="page-wrapper">
		    <div class="container-fluid">
		        ...
		        <div class="row">
		            <a class="btn btn-outline btn-primary btn-xs" href="<?= base_url('food_n_go/kendaraan/pesan_kendaraan_oleh_pengelola')?>" title="kembali"><i class="fa fa-arrow-circle-left fa-fw"></i> Kembali</a>
		        </div>
		        <div class="panel-body">
		            <form role="form" action="<?php echo base_url(); ?>food_n_go/kendaraan/pesan_kendaraan_oleh_pengelola/action_insert_data_pemesanan" id="formulir_tambah" method="post">
		                <div class="row">
		                    <div class="form-group">
		                        ...
		                        <div class="col-lg-7">
		                            <input type="text" class="form-control" style="width: 100%;" placeholder="Harus diisi" title="" value="<?= $this->session->userdata('no_pokok').' - '.$this->session->userdata('nama')?>" readonly>
		                        </div>
		                ...
		                <div class="row">
		                    <div class="form-group">
		                        ...
		                        <div class="col-lg-7">
		                            <select class="form-control select2" id="kode_unit_pemesan" name="kode_unit_pemesan" onChange="get_pic();" style="width: 100%;" required>
                                        <option></option>
		...
		<script type="text/javascript">
            ...
            function get_pic(){
                ...
                $.ajax({
		            url: "<?php echo base_url('food_n_go/kendaraan/pesan_kendaraan_oleh_pengelola/get_pic');?>",
		            type: "POST",
		            dataType: "json",
		            data: {kode_unit: kode_unit_pemesan},
		            success: function(response) {
