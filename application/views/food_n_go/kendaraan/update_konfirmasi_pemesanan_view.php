		...
		<div id="page-wrapper">
		    <div class="container-fluid">
		        ...
		        <div class="panel-body">
                    ...
                    <?php if(@$row->verified==1 && @$row->status_persetujuan_admin==null){?>
		            <form method="post" action="<?= base_url('food_n_go/kendaraan/konfirmasi_pemesanan/save_update_konfirmasi')?>" id="form-update-approval">
		                <div class="alert alert-info">
                            ...
                            <select class="form-control" name="status_persetujuan_admin" id="status_persetujuan_admin" onchange="form_alasan_1()" style="width: 150px;" required>
                                ...
                                <option value="3">Setuju - Gocorp Bluebird Reimburse</option>
                            ...
                            <div id="form-alasan-1" style="display: none;">
                                ...
                                <select class="form-control select2" name="id_mst_driver" id="id_mst_driver" onchange="set_driver(); set_button();detail_driver();load_table();" style="width: 100%;">
                                    ...
                                    <option value="<?= $x->id?>" data-kode="<?= $x->id_mst_kendaraan_default?>"><?= $x->np_karyawan.' - '.$x->nama.' ('.$x->countt.')'?></option>
                                    <?php }?>
                                </select>
		...
		<script type="text/javascript">
            ...
            function form_alasan_1(){
                ...
                if(status_persetujuan_admin==2){
                    ...
                    $('#form-alasan-2').show();
                    $('#div-table').hide();
                } else if(status_persetujuan_admin==1 || status_persetujuan_admin==3){
            ...
            function set_button(){
                ...
                } else if(status_persetujuan_admin==1 || status_persetujuan_admin==3 /* && id_mst_driver!='' && id_mst_kendaraan!='' */){
                    $('#btn-approval').prop('disabled',false);
                } else{
