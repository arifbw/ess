...
<page orientation="portrait" format="A4" backtop="5mm" backbottom="5mm" backleft="5mm" backright="5mm">
    ...
    <table class="w-100" style="vertical-align: top !important;">
        <tr class="top-head">
            <td class="ket-pemesan lh-1 py-4 pl-4" style="width:60%; text-align: center;">
                Deskripsi
            </td>
            <td class="ket-pemesan lh-1 py-4 text-center" style="width:20%; text-align: center;">
                Harga / PCS
            </td>
            <td class="ket-pemesan lh-1 py-4 text-center" style="width:20%; text-align: center;">
                Kuantitas
        ...
        ?>
        <tr>
            <td class="lh-1 pl-4" style="width:60%;">
                <?php 
            ...
            <td class="lh-1 text-center" style="width:20%; text-align: right; padding-right: 15px;">
                <?php 
                    $count = 0; foreach($fix_detail_snack as $row){
                    if($count==0) echo '<br>';
