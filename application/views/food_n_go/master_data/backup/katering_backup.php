		...
		<div id="page-wrapper">
			<div class="container-fluid">
											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="nama" value="<?php echo $nama;?>" placeholder="Nama Katering">
														</div>
				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_daftar_katering">
								<thead>
									<tr>
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_katering);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												...
												echo "<td>".$daftar_katering[$i]["nama"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_katering[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_katering[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if(@$akses["ubah"] or @$akses["lihat log"]){
													echo "<td class='text-center'>";
														if(@$akses["ubah"]){
															echo "<button type='button' class='btn btn-primary btn-xs' data-id='".$daftar_katering[$i]["id"]."' data-nama='".$daftar_katering[$i]["nama"]."' data-status='".$daftar_katering[$i]["status"]."' onclick='tampil_data_ubah_new(this)'>Ubah</button> ";
														}
														if(@$akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_katering[$i]["nama"]."\",".$daftar_katering[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
						...
						<div class="modal fade" id="modal_ubah" tabindex="-1" role="dialog" aria-labelledby="label_modal_ubah" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<form role="form" action="<?= base_url('food_n_go/master_data/daftar_katering')?>" id="formulir_ubah" method="post">
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														...
														<input type="text" class="form-control" name="nama_ubah" id="nama_ubah" value="" placeholder="Nama Katering" required>
													</div>
