...
<div id="page-wrapper">
	<div class="container-fluid">
				...
				<div class="panel panel-default">
					...
					<div id="collapseOne" class="panel-collapse collapse <?php echo $panel_tambah;?>">
						<div class="panel-body">
							<form role="form" action="<?= site_url('food_n_go/master_data/daftar_gedung/index'); ?>" id="formulir_tambah" method="post">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-7">
											<input class="form-control" name="nama" placeholder="Masukkan Nama Gedung" required>
										</div>
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-7">
											<select class="select2" name="lokasi" required>
												<?php
		...
		?>
		<div class="row">
			<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_daftar_gedung">
				<thead>
					<tr>
		        		...
		        		<form role="form" action="<?= site_url('food_n_go/master_data/daftar_gedung/index'); ?>" id="formulir_tambah" method="post">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-7">
										<input id="nama-gedung" class="form-control" name="nama" placeholder="Masukkan Nama Gedung" required>
									</div>
									<div id="warning_nama" class="col-lg-3 text-danger"></div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									...
									<div class="col-lg-7">
										<select style="width: 100%;" id="lokasi-gedung" class="select2" name="lokasi" required>
											<?php
												foreach ($daftar_lokasi as $value) {
											?>
											<option value="<?= $value->id; ?>"><?= $value->nama; ?></option>
							...
							<input id="no-gedung" type="hidden" name="id" />
							<div class="row">
								<div class="col-lg-12 text-center">
									<button type="submit" class="btn btn-primary" onclick="return cek_simpan_tambah()">Simpan</button>
								</div>
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $(document).on('click', '.ubah', function(){
	    	...
	    	$.ajax({
	    		url: "<?php echo site_url('food_n_go/master_data/daftar_gedung/detail/'); ?>"+id,
	    		success: function(data) {
	    			$('#nama-gedung').val(data.result.nama);
	    			$('#status-lama').val(data.result.status);
	    			$('#no-gedung').val(data.result.id);
	    			$('#lokasi-gedung').val(data.result.lokasi);
	    			$('#lokasi-gedung').select2().trigger('click');
