		        ...
		        <div class="form-group">
		            <div class="row">
		                <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" id="tahun" style="width: 200px;" value="<?= date('Y')?>">
                            <!--<select class="form-control" style="width: 200px;" id="tahun">
                                <?php foreach(@$tahun as $row){?>
                                <option value="<?= $row->tahun?>"><?= $row->tahun?></option>
                                <?php } ?>
                            </select>-->
                            <input type="checkbox" id="regenerate"> <small>Perbarui ulang laporan global?</small>
		                </div>
		...
		<script type="text/javascript">
            ...
            function proses() {
		        var url = '<?= base_url('food_n_go/rekap/transportasi/laporan_global/proses/')?>';
                var tanggal = $('#tahun').val();
                var unit = $('#unit').val();
