								...
								<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_payslip">
									<thead>
										<tr>
											...
											<th class='text-center no-sort'>Pembayaran</th>
		...
		<script type="text/javascript">	
			...
			function table_serverside(){
				...
				table = $('#tabel_payslip').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url("informasi/gaji/tabel_gaji/")?>",
						"type": "POST"
					},
			...
			$(document).on( "click", '.lihat_button',function(e) {		
				var id_payslip_karyawan = $(this).data('id_payslip_karyawan');
	
				$.ajax({
				type: "POST",
				dataType: "html",
				url: document.getElementById("base_url").value+"informasi/gaji/ajax_get_gaji/"+id_payslip_karyawan,
				data: "id_payslip_karyawan="+id_payslip_karyawan,
