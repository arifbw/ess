		...
		<div id="page-wrapper">
			<div class="container-fluid">
											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="keterangan" value="<?php echo $keterangan;?>" placeholder="Keterangan">
														</div>
												...
												<div class="row">
													<div class="form-group">
														<div class="col-lg-2">
															<label>Kode Pamlek</label>
														</div>
														<div class="col-lg-7">
															<input class="form-control" name="kode_pamlek" value="<?php echo $kode_pamlek;?>" placeholder="Kode Pamlek">
														</div>
														<div id="warning_kode_pamlek" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
													<div class="form-group">
				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_attendance">
								<thead>
									<tr>
										<th class='text-center'>Nama</th>
										<th class='text-center'>Keterangan</th>
										<th class='text-center'>Kode Pamlek</th>
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_attendance);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												echo "<td>".$daftar_attendance[$i]["nama"]."</td>";
												echo "<td>".$daftar_attendance[$i]["keterangan"]."</td>";
												echo "<td>".$daftar_attendance[$i]["kode_pamlek"]."</td>";
												echo "<td>".$daftar_attendance[$i]["kode_erp"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_attendance[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_attendance[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														...
														if($akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_attendance[$i]["nama"]."\",".$daftar_attendance[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
										...
										<div class="modal-body">
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														...
														<input class="form-control" name="keterangan_ubah" value="" placeholder="Keterangan">
													</div>
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														<input type="hidden" name="kode_pamlek" value="">
														<input class="form-control" name="kode_pamlek_ubah" value="" placeholder="Kode Pamlek">
													</div>
													<div id="warning_kode_pamlek_ubah" class="col-lg-4 text-danger"></div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														<input type="hidden" name="kode_erp" value="">
														<input class="form-control" name="kode_erp_ubah" value="" placeholder="Kode ERP">
													</div>
													<div id="warning_kode_erp_ubah" class="col-lg-4 text-danger"></div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
