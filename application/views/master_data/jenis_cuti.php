											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="uraian" value="<?php echo $uraian;?>" placeholder="uraian">
														</div>
				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_perizinan">
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_jenis_cuti);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												echo "<td align='center'>".$daftar_jenis_cuti[$i]["kode_erp"]."</td>";
												echo "<td>".$daftar_jenis_cuti[$i]["uraian"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_jenis_cuti[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_jenis_cuti[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														...
														if($akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_jenis_cuti[$i]["uraian"]."\",".$daftar_jenis_cuti[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														...
														<input class="form-control" name="uraian_ubah" value="" placeholder="uraian">
													</div>
													<div id="warning_uraian_ubah" class="col-lg-4 text-danger"></div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
