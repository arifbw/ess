				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_perizinan">
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_perizinan);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												echo "<td>".$daftar_perizinan[$i]["nama"]."</td>";
												echo "<td>".$daftar_perizinan[$i]["keterangan"]."</td>";
												echo "<td>".$daftar_perizinan[$i]["kode_pamlek"]."</td>";
												echo "<td>".$daftar_perizinan[$i]["kode_erp"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_perizinan[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_perizinan[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														...
														if($akses["lihat log"]){
															echo "<button class='btn btn-primary btn-xs' onclick='lihat_log(\"".$daftar_perizinan[$i]["nama"]."\",".$daftar_perizinan[$i]["id"].")'>Lihat Log</button>";
														}
													echo "</td>";
												}
											echo "</tr>";
