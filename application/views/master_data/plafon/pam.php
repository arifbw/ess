                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form role="form" action="<?= base_url(); ?>master_data/plafon/pam/action_insert" id="formulir_tambah" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    const tableServerside = async () => {
		table = $('#data-table').DataTable({
			...
			"ordering": false,
			"ajax": {				
				"url"	: "<?php echo site_url("master_data/plafon/pam/tabel_pam")?>",					 
				"type"	: "POST",
				"data"	: {}
			},
			"columnDefs": [
    ...
    const edit = async (data) => {
		...
		let fields = ['np_karyawan', 'nama_karyawan', 'alamat', 'plafon'];
    ...
    const hapus = async (data) =>{
		...
		if (result) {
			$.ajax({
				type: "POST",
				url: `<?= base_url('master_data/plafon/pam/hapus')?>`,
				data: {id: data.id},
				dataType: 'json',
