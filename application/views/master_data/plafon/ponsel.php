                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form role="form" action="<?= base_url(); ?>master_data/plafon/ponsel/action_insert" id="formulir_tambah" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    const tableServerside = async () => {
		table = $('#data-table').DataTable({
			...
			"ordering": false,
			"ajax": {				
				"url"	: "<?php echo site_url("master_data/plafon/ponsel/tabel_ponsel")?>",					 
				"type"	: "POST",
				"data"	: {}
			},
			"columnDefs": [
    ...
    const hapus = async (data) =>{
		...
		if (result) {
			$.ajax({
				type: "POST",
				url: `<?= base_url('master_data/plafon/ponsel/hapus')?>`,
				data: {id: data.id},
				dataType: 'json',
    ...
    const findDataKaryawan = async ()=>{
        ...
        if (typeof findData!='undefined'){
            ...
            $("#nama_karyawan").val('');
            $("#nama_jabatan").val('');
            alert('NP tidak ada di Master Data, silakan lengkapi Nama Karyawan');
        }
    }
</script>