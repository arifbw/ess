                            ...
                            <div class="panel-body">
                                <form role="form" action="<?= base_url(); ?>master_data/plafon/tv/action_insert" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <select class="form-control" name="layanan" id="layanan" style="width: 100%" required>
                                                <?php foreach ($ref_layanan as $value): ?>
                                                    <option value="<?= $value['nama'] ?>" <?= $value['status']=='0'?' disabled':''?>><?= $value['nama'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input class="form-control" type="text" name="no_id" id="no_id" placeholder="Masukkan No ID" required>
                                        </div>														
                                    </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="data-table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center no-sort">No ID</th>
...
<script type="text/javascript">
    ...
    const edit = async (data) => {
		...
		let fields = ['np_karyawan', 'nama_karyawan', 'nama_jabatan', 'alamat', 'no_id', 'plafon', 'layanan'];
