											...
											<form role="form" action="" id="formulir_tambah" method="post">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input class="form-control" name="kode_pos" value="<?php echo $kode_pos;?>" placeholder="Kode Pos">
														</div>
														<div id="warning_kode_pos" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
													<div class="form-group">
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_pos);$i++){
											...
											echo "<tr class='$class'>";
												echo "<td align='center'>".$daftar_pos[$i]["kode_pos"]."</td>";
												echo "<td>".$daftar_pos[$i]["nama"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_pos[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_pos[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												if($akses["ubah"] or $akses["lihat log"]){
													echo "<td class='text-center'>";
														if($akses["ubah"]){
															...
															echo "<a class='btn btn-primary btn-xs' href='".base_url('master_data/pos/hak_akses/'.$daftar_pos[$i]["id"])."'>Hak Akses</a>";
														}
													echo "</td>";
												}
											echo "</tr>";
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-5">
														...
														<input class="form-control" name="kode_pos_ubah" value="" placeholder="Kode Pos">
													</div>
													<div id="warning_kode_pos_ubah" class="col-lg-4 text-danger"></div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
