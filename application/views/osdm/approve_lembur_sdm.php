			...
			<form role="form" action="<?php echo site_url('osdm/persetujuan_lembur_sdm/save') ?>" method="post">	
				<table>
					...
					<tr>
						...
						<td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
						<td><a><?= (($waktu_mulai_fix!=null || $waktu_mulai_fix!='') && ($waktu_selesai_fix!=null || $waktu_selesai_fix!='')) ? datetime_indo($waktu_mulai_fix).' - '.datetime_indo($waktu_selesai_fix) : 'Tidak Diakui' ?></a></td>
					</tr>
					<tr>
				...
				<?php if ($approval_pimpinan_status != null || $approval_pimpinan_status != '0' || $approval_pimpinan_status != '') { ?>
					<?php
						if ($approval_pimpinan_status=='1') { ?>
						<div class="alert alert-info">
						<b><span class="text-danger">Sudah Disetujui</span><span> Oleh Atasan <?= $approval_pimpinan_nama.'('.$approval_pimpinan_np.')' ?> Pada <?= $approval_pimpinan_date ?></span></b>
						</div>
					<?php } 
						else if ($approval_pimpinan_status=='2') { ?>
						<div class="alert alert-info">
						<b><span class="text-danger">Tidak Disetujui</span><span> Oleh Atasan <?= $approval_pimpinan_nama.'('.$approval_pimpinan_np.')' ?> Pada <?= $approval_pimpinan_date ?></span></b><br>
				...
				<?php if ($approval_status != null || $approval_status != '0' || $approval_status != '') { ?>
					<?php
						...
						$tolak = ''; ?>
						<div class="alert alert-info">
						<b><span class="text-danger">Sudah Disetujui</span><span> Oleh SDM <?= $approval_nama.'('.$approval_np.')' ?> Pada <?= $approval_date ?></span></b>
						</div>
					<?php } 
						...
						$tolak = 'selected'; ?>
						<div class="alert alert-info">
						<b><span class="text-danger">Tidak Disetujui</span><span> Oleh SDM <?= $approval_nama.'('.$approval_np.')' ?> Pada <?= $approval_date ?></span></b><br>
