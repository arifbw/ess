                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>pelaporan/anak_tertanggung/action_insert_anak_tertanggung" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="status_pekerjaan" id="status_pekerjaan" placeholder="Masukkan Status Pekerjaan" required>
                                    </div>														
                                </div>
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="nama_instansi" id="nama_instansi" placeholder="Masukkan Nama Instansi" required>
                                    </div>														
                                </div>

                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Nomor Telpon Instansi</label>
                                    </div>
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="telpon_instansi" id="telpon_instansi" placeholder="Masukkan Nomor Telpon Instansi" required>
                                    </div>														
                                </div> -->
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Surat Keterangan Tidak Mendapat Fasilitas Kesehatan</label>
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" type="text" name="no_kk" id="no_kk" placeholder="Masukkan Nomor Dokumen" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <input class="form-control" type="file" name="kk" id="kk" accept="application/pdf,image/*" required><small class="form-text text-danger">Dokumen PDF/JPG Max 2MB</small><!-- <strong> (wajib diisi)</strong> -->
                                    </div>
                                    <div class="col-lg-3" id="edit_kk">
									</div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" type="text" name="no_akta_kelahiran" id="no_akta_kelahiran" placeholder="Masukkan Nomor Dokumen" required>
                                    </div>
                                    <div class="col-lg-3">
                                        <input class="form-control" type="file" name="akta_kelahiran" id="akta_kelahiran" accept="application/pdf,image/*" required><small class="form-text text-danger">Dokumen PDF/JPG Max 2MB</small><!-- <strong> (wajib diisi)</strong> -->
                                    </div>
                                    <div class="col-lg-3" id="edit_akta_kelahiran">
									</div>
                                </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="daftar_anak_tertanggung">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center no-sort">Status Pekerjaan</th>
...
<script type="text/javascript">
    ...
    function table_serverside() {
        ...
        table = $('#daftar_anak_tertanggung').DataTable({ 
            ...
            "ajax": {
                "url": "<?= site_url("pelaporan/anak_tertanggung/tabel_anak_tertanggung/")?>",
                "type": "POST",
            },
...
<script>
    const edit = async (data) => {
        ...
        let fields = ['np_karyawan', 'nama_anak', 'tempat_lahir_anak', 'tanggal_lahir_anak', 'status_pekerjaan', 'no_surat_keterangan', 'no_akta_kelahiran', 'no_kk', 'approval_1_np', 'keterangan'];
        ...
        $('#edit_akta_kelahiran').html('<label class="text-danger"><b>Upload Ulang Jika Ingin Mengganti File</b></label>');
        $('#kk').prop('required',false);
        $('#edit_kk').html('<label class="text-danger"><b>Upload Ulang Jika Ingin Mengganti File</b></label>');
    ...
    $(document).on('click','.hapus',function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('<?= site_url("pelaporan/anak_tertanggung/hapus") ?>/'+$(this).data('id')+'/'+$(this).data('np'),
                    function(get){
                        ret = JSON.parse(get);
                        if (ret.status==true) {
                            Swal.fire(
