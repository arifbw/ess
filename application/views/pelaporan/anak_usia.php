                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>pelaporan/anak_usia/action_insert_anak_usia" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="nama_sekolah" id="nama_sekolah" placeholder="Masukkan Nama Sekolah/Universitas" required>
                                    </div>                                          
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="number" name="kelas" id="kelas" placeholder="Masukkan Kelas/Semester" required>
                                    </div>                                          
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Bukti Pembayaran Sekolah/Surat Keterangan dari Sekolah</label>
                                    </div>
                                    <div class="col-lg-7">
                                        <input class="form-control" type="file" name="dok_keterangan_sekolah" id="dok_keterangan_sekolah" accept="application/pdf,image/*" required><small class="form-text text-danger">Dokumen PDF/JPG Max 2MB</small><!-- <strong> (wajib diisi)</strong> -->
                                    </div>
                                    <div class="col-lg-3" id="edit_dok_keterangan_sekolah">
									</div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Surat Pernyataan Anak Belum Menikah dan Bekerja</label>
                                    </div>
                                    <div class="col-lg-7">
                                        <input class="form-control" type="file" name="dok_pernyataan" id="dok_pernyataan" accept="application/pdf,image/*" required><small class="form-text text-danger">Dokumen PDF/JPG Max 2MB</small><br><a class="btn btn-danger btn-xs" href="<?= base_url('uploads/pelaporan/anak_usia/Surat_pernyataan.pdf') ?>" target="_blank">Unduh Template Surat Pernyataan</a>
                                    </div>
                                    <div class="col-lg-3" id="edit_dok_pernyataan">
									</div>
                                </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="daftar_kelahiran_anak">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center no-sort">Sekolah/Universitas</th>
...
<script type="text/javascript">
    ...
    function table_serverside() {
        ...
        table = $('#daftar_kelahiran_anak').DataTable({ 
            ...
            "ajax": {
                "url": "<?= site_url("pelaporan/anak_usia/tabel_anak_usia/")?>",
                "type": "POST",
            },
...
<script>
    const edit = async (data) => {
        ...
        let fields = ['np_karyawan', 'nama_anak', 'jenis_kelamin_anak', 'tempat_lahir_anak', 'tanggal_lahir_anak', 'anak_ke', 'nama_sekolah', 'kelas', 'approval_1_np', 'keterangan'];
        ...
        $('#dok_keterangan_sekolah').prop('required',false);
        $('#edit_dok_keterangan_sekolah').html('<label class="text-danger"><b>Upload Ulang Jika Ingin Mengganti File</b></label>');
        $('#dok_pernyataan').prop('required',false);
        $('#edit_dok_pernyataan').html('<label class="text-danger"><b>Upload Ulang Jika Ingin Mengganti File</b></label>');
    ...
    $(document).on('click','.detail_button',function(e){
        ...
        $.post('<?php echo site_url("pelaporan/anak_usia/view_detail") ?>',
    ...
    $(document).on('click','.hapus',function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('<?= site_url("pelaporan/anak_usia/hapus") ?>/'+$(this).data('id')+'/'+$(this).data('np'),
                    function(get){
                        ret = JSON.parse(get);
                        if (ret.status==true) {
                            Swal.fire(
