                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>pelaporan/kelahiran_anak/action_insert_kelahiran_anak" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-2">
                                        <label>Surat Keterangan Lahir/Akta Kelahiran</label>
                                    </div>
                                    <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    function table_serverside() {
        ...
        table = $('#daftar_kelahiran_anak').DataTable({ 
            ...
            "ajax": {
                "url": "<?= site_url("pelaporan/kelahiran_anak/tabel_kelahiran_anak/")?>",
                "type": "POST",
            },
...
<script>
    const edit = async (data) => {
        ...
        let fields = ['np_karyawan', 'nama_anak', 'tempat_lahir_anak', 'tanggal_lahir_anak', 'jenis_kelamin_anak', 'anak_ke', 'no_akta_kelahiran', 'no_dokumen_lain', 'approval_1_np', 'keterangan'];
    ...
    $(document).on('click','.detail_button',function(e){
        ...
        $.post('<?= site_url("pelaporan/kelahiran_anak/view_detail") ?>',
    ...
    $(document).on('click','.hapus',function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('<?= site_url("pelaporan/kelahiran_anak/hapus") ?>/'+$(this).data('id')+'/'+$(this).data('np'),
                    function(get){
                        ret = JSON.parse(get);
                        if (ret.status==true) {
                            Swal.fire(
