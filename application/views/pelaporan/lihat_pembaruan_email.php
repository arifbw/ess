                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>pelaporan/pembaruan_email/action_insert" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <!-- Input Email Lama -->
                                        <input class="form-control" type="email" name="email_lama" id="email_lama" placeholder="Masukkan Email Lama" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <!-- Input Email Baru -->
                                        <input class="form-control" type="email" name="email_baru" id="email_baru" placeholder="Masukkan Email Baru" required>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
            ...
            $('#modal-inactive').on('show.bs.modal', function(event) {
                ...
                var modal = $(this);
                var button = $(event.relatedTarget); // Button yang memicu modal
                var emailLama = button.closest('tr').find('td:eq(2)').text(); // Mengambil teks dari kolom email lama
                var emailBaru = button.closest('tr').find('td:eq(3)').text(); // Mengambil teks dari kolom email baru
                var modal = $(this);

                modal.find('#message-inactive').html('<b>Email Lama:</b> ' + emailLama + '<br><b>Email Baru:</b> ' + emailBaru);


                modal.find('#inactive-action').on('click', function(e) {
                    e.preventDefault(); // Mencegah aksi default dari link

                    $.post('<?= base_url() ?>pelaporan/pembaruan_email/delete_data/' + idToDelete, function(response) {
                        if (response === 'success') {
        ...
        $('#laporan_perubahan_email_table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('pelaporan/pembaruan_email/tabel_laporan_perubahan_email'); ?>",
                "type": "POST"
            },
            "columns": [{
                    "data": "0"
