		...
		<script type="text/javascript">
			...
			function table_serverside() {
				...
				table = $('#daftar_anak_tertanggung').DataTable({ 
					...
					"ajax": {
						"url": "<?= site_url("pelaporan/persetujuan/anak_tertanggung/tabel_anak_tertanggung/")?>",
						"type": "POST",
					},
		...
		<script>
			$(document).on('click','.detail_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/anak_tertanggung/view_detail") ?>',
			...
			$(document).on('click','.persetujuan_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/anak_tertanggung/view_approve") ?>',
					{id_:$(this).attr('data-id')},
					function(e){
						$(".set-approve").html(e);
					}
