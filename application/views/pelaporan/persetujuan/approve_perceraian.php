...
<form role="form" action="<?= base_url(); ?>pelaporan/persetujuan/perceraian/save_approve/" id="formulir_tambah" method="post">	
	<div class="row">
		<div class="col-md-10">
			<table>
				<tr>
				...
				<tr>
					<th>No Surat Cerai</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
					<td><b><a><?= $detail['no_surat_cerai'] ?></a></b></td>
				</tr>
				<tr>
					<th>No Putusan Pengadilan</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
					<td><b><a><?= $detail['no_putusan_pengadilan'] ?></a></b></td>
				</tr>
				<tr>
					<th>Keterangan</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
