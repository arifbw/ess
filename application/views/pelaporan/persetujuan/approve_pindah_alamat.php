...
<form role="form" action="<?= base_url(); ?>pelaporan/persetujuan/pindah_alamat/save_approve/" id="formulir_tambah" method="post">	
	<div class="row">
		<div class="col-md-10">
			<table>
				<tr>
				...
				<tr>
					<th>Alamat Lama</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
					<td><b><a><?= '('.$detail['jenis_alamat_lama'].') '.$detail['alamat_lama'].'<br><small>'.$detail['kelurahan_lama'].', '.$detail['kecamatan_lama'].', '.$detail['kabupaten_lama'].', '.$detail['provinsi_lama'].'</small>' ?></a></b></td>
				</tr>
				<tr>
					<th>Alamat Baru</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
					<td><b><a><?= '('.$detail['jenis_alamat_baru'].') '.$detail['alamat_baru'].'<br><small>'.$detail['kelurahan_baru'].', '.$detail['kecamatan_baru'].', '.$detail['kabupaten_baru'].', '.$detail['provinsi_baru'].'</small>' ?></a></b></td>
				</tr>
				<tr>
					<th>No KTP</th>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</td>
