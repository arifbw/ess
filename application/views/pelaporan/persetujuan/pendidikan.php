		...
		<script type="text/javascript">
			...
			function table_serverside()
			{
				...
				table = $('#daftar_pendidikan').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url("pelaporan/persetujuan/pendidikan/tabel_pendidikan/")?>",
						"type": "POST",
					},
		...
		<script>
			$(document).on('click','.detail_button',function(e){
	            ...
	            $.post('<?php echo site_url("pelaporan/persetujuan/pendidikan/view_detail") ?>',
	        ...
	        $(document).on('click','.persetujuan_button',function(e){
	            ...
	            $.post('<?php echo site_url("pelaporan/persetujuan/pendidikan/view_approve") ?>',
	                {id_:$(this).attr('data-id')},
	                function(e){
	                    $(".set-approve").html(e);
	                }
