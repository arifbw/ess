		...
		<script type="text/javascript">
			...
			function table_serverside() {
				...
				table = $('#daftar_pernikahan').DataTable({ 
					...
					"ajax": {
						"url": "<?= site_url("pelaporan/persetujuan/pernikahan/tabel_pernikahan/")?>",
						"type": "POST",
					},
		...
		<script>
			$(document).on('click','.detail_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pernikahan/view_detail") ?>',
			...
			$(document).on('click','.persetujuan_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pernikahan/view_approve") ?>',
					{id_:$(this).attr('data-id')},
					function(e){
						$(".set-approve").html(e);
					}
