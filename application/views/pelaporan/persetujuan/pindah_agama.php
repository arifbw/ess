		...
		<script type="text/javascript">
			...
			function table_serverside() {
				...
				table = $('#daftar_pindah_agama').DataTable({ 
					...
					"ajax": {
						"url": "<?= site_url("pelaporan/persetujuan/pindah_agama/tabel_pindah_agama/")?>",
						"type": "POST",
					},
		...
		<script>
			$(document).on('click','.detail_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pindah_agama/view_detail") ?>',
			...
			$(document).on('click','.persetujuan_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pindah_agama/view_approve") ?>',
					{id_:$(this).attr('data-id')},
					function(e){
						$(".set-approve").html(e);
					}
