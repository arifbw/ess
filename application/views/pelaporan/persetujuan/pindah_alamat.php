		...
		<script type="text/javascript">
			...
			function table_serverside() {
				...
				table = $('#daftar_pindah_alamat').DataTable({ 
					...
					"ajax": {
						"url": "<?= site_url("pelaporan/persetujuan/pindah_alamat/tabel_pindah_alamat/")?>",
						"type": "POST",
					},
		...
		<script>
			$(document).on('click','.detail_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pindah_alamat/view_detail") ?>',
			...
			$(document).on('click','.persetujuan_button',function(e){
				...
				$.post('<?= site_url("pelaporan/persetujuan/pindah_alamat/view_approve") ?>',
					{id_:$(this).attr('data-id')},
					function(e){
						$(".set-approve").html(e);
					}
