		...
		<div id="page-wrapper">
			<div class="container-fluid">
							...
							<div class="row">
                                ...
                                <div class="col-md-3">
									<div style="padding-top: 25px">
										<button type="button" onClick="otoritas()" class="btn btn-success"><i class="fa fa-print"></i> Cetak <?php echo $this->session->flashdata("bulan_tahun") ?></button>
									</div>
									<div style="padding-top: 25px">
										<button type="button" onClick="refresh_table_serverside()" class="btn btn-primary"><i class="fa fa-refresh"></i> Refresh </button>
									</div>
								        	...
								        	<form method="post" target="_blank" action="<?php echo base_url('perizinan/data_perizinan_x/cetak')?>">
									          	<div class="modal-content">
													...
													<div class="modal-body">
                                                        ...
                                                        <input type="checkbox" id="all-karyawan" name="all_karyawan" onchange="checkAllKaryawan()"> Semua NP dalam otoritas
                                                        <!-- END tambahan untuk cetak semua NP, 2021-03-10 -->
                                                        
                                                        <div id="div_multi_select">
				...
				?>
						<!-- Modal -->
						<div class="modal fade " id="modal_persetujuan" tabindex="-1" role="dialog">
						...
						<!-- Modal -->
						<div class="modal" id="modal_batal_izin" tabindex="-1" role="dialog">
							<div class="modal-dialog modal-sm">
								<form role="form" action="<?php echo base_url(); ?>perizinan/persetujuan_keamanan/save_approve/batal" id="formulir_tambah" method="post">	
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										...
										<div class="modal-body">
											<div align='center'>		
												<textarea name='alasan_batal' class="form-control" placeholder="Masukkan Alasan Pembatalan Perizinan" rows="5"></textarea>
											</div>	
										</div>
										<div class="modal-footer">
											<a class="btn btn-default" data-dismiss="modal">Tutup</a>
											<button type="submit" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin membatalkan izin?');">Batalkan perizinan</button>
										</div>
									</div>
								</form>
							</div>
...
//                alert('asdfsd');
            ...
            $(document).on('click','.persetujuan_button',function(e){
	            ...
	            $.post('<?php echo site_url("perizinan/persetujuan_keamanan/view_approve") ?>',
	                {id_perizinan:$(this).attr('data-id'), tgl:$(this).attr('data-tgl'), date_range:date_range, bulan_tahun:bulan_tahun, get_pos:get_pos, izin_0:izin_0, izin_C:izin_C, izin_E:izin_E, izin_F:izin_F, izin_G:izin_G, izin_H:izin_H, izin_TM:izin_TM, izin_TK:izin_TK},
	                function(e){
	                    $(".get-approvee").html(e);
	                }
	            );
			...
			function table_serverside()
			{
				...
				table = $('#tabel_data_perizinan').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url("perizinan/persetujuan_keamanan/tabel_persetujuan_keamanan/")?>"+ bulan_tahun + '/' + izin_0 + '/' + izin_C + '/' + izin_E + '/' + izin_F + '/' + izin_G + '/' + izin_H + '/' + get_pos,
						"type": "POST",
