                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>pelaporan/suami_tertanggung/action_insert_suami_tertanggung" id="formulir_tambah" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="nama_suami" id="nama_suami" placeholder="Masukkan Nama Suami" required>
                                    </div>														
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control" type="text" name="tempat_lahir_suami" id="tempat_lahir_suami" placeholder="Masukkan Tempat Lahir Suami" required>
                                    </div>														
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7">
                                        <input class="form-control tanggal" type="text" name="tanggal_lahir_suami" id="tanggal_lahir_suami" placeholder="Masukkan Tanggal Lahir Suami" required>
                                    </div>
                                </div>
        ...
        <?php if($this->akses["lihat"]): ?>
            <div class="form-group">	
                <div class="row table-responsive">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="daftar_suami_tertanggung">
                        <thead>
                            <tr>
                                <th class="text-center no-sort" style="max-width: 5%">No</th>
                                <th class="text-center">Pegawai</th>  <!-- style="max-width: 15%" -->
                                <th class="text-center no-sort">Nama Suami</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#daftar_suami_tertanggung').DataTable().destroy();				
        table_serverside();
    });
    ...
    function table_serverside() {
        ...
        table = $('#daftar_suami_tertanggung').DataTable({ 
            ...
            "ajax": {
                "url": "<?= site_url("pelaporan/suami_tertanggung/tabel_suami_tertanggung/")?>",
                "type": "POST",
            },
...
<script>
    const edit = async (data) => {
        ...
        let fields = ['np_karyawan', 'nama_suami', 'tempat_lahir_suami', 'tanggal_lahir_suami', 'status_pekerjaan', 'nama_instansi', 'telpon_instansi', 'no_surat_keterangan', 'approval_1_np', 'keterangan'];
    ...
    $(document).on('click','.detail_button',function(e){
        ...
        $.post('<?php echo site_url("pelaporan/suami_tertanggung/view_detail") ?>',
    ...
    $(document).on('click','.hapus',function(e){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('<?= site_url("pelaporan/suami_tertanggung/hapus") ?>/'+$(this).data('id')+'/'+$(this).data('np'),
                    function(get){
                        ret = JSON.parse(get);
                        if (ret.status==true) {
                            Swal.fire(
