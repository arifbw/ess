			...
			<form role="form" action="<?php echo base_url(); ?>pelaporan/verifikasi/suami_tertanggung/save_approve/" id="formulir_tambah" method="post">	
				<div class="row">
					<div class="col-md-12">
						<table>
							<tr>
				...
				<div id="set_approve">
					<div class="alert alert-<?= $sdm_warna ?>">
						<strong><a class="text-<?= $sdm_warna ?>">Verifikasi Laporan Suami Tertanggung</a></strong><br>
            ...
            $(document).on('click','#set_submit_erp',function(e){
	            ...
	            Swal.fire({
				  	...
				  	if (result.isConfirmed) {
			            $.post('<?php echo site_url("pelaporan/verifikasi/suami_tertanggung/save_erp") ?>',
			                {id_: '<?= $detail['id'] ?>'},
			                function(get){
			                	ret = JSON.parse(get);
			                	if (ret.status==true) {
