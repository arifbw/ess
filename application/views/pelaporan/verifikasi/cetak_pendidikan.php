        ...
        <div id="container">
            ...
            <div id="body">
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>1.&nbsp;&nbsp;Nomor Ijazah</td>
                        <td>:</td>
                        <td><?= $data['no_ijazah'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>2.&nbsp;&nbsp;Nomor Transkrip</td>
                        <td>:</td>
                        <td><?= $data['no_transkrip'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>3.&nbsp;&nbsp;Nama PT</td>
                    ...
                    <tr>
                        ...
                        <td>5.&nbsp;&nbsp;Jurusan</td>
                        <td>:</td>
                        <td><?= $data['jenjang'].' '.$data['jurusan'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>6.&nbsp;&nbsp;Akreditasi</td>
                    ...
                    <tr>
                        <td></td>
                        <td>7.&nbsp;&nbsp;Tanggal Masuk Pendidikan</td>
                        <td>:</td>
                        <td><?= $data['tgl_masuk'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>8.&nbsp;&nbsp;Tanggal Selesai Pendidikan</td>
                        <td>:</td>
