        ...
        <div id="container">
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><?= ucwords(strtolower($data['tempat_lahir'])).' / '.tanggal_indonesia($data['tanggal_lahir']) ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>6.&nbsp;&nbsp;Agama</td>
                    ...
                    <tr>
                        <th>II.</th>
                        <th colspan="2">DATA ISTRI / SUAMI</th>
                    </tr>
                    <tr>
                        <td></td>
                        <td>1.&nbsp;&nbsp;Nama</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><?= ucwords(strtolower($data['tempat_lahir_pasangan'])).' / '.tanggal_indonesia($data['tanggal_lahir_pasangan']) ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>3.&nbsp;&nbsp;Agama</td>
                    ...
                    <tr>
                        <th>III.</th>
                        <th colspan="2">MELAPORKAN PERCERAIAN</th>
                    </tr>
                    <tr>
                        <td></td>
                        <td>1.&nbsp;&nbsp;Hari</td>
                        <td>:</td>
                        <td><?= $data['hari_perceraian'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>2.&nbsp;&nbsp;Tanggal</td>
                        <td>:</td>
                        <td><?= tanggal_indonesia($data['tanggal_perceraian']) ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>3.&nbsp;&nbsp;Tempat</td>
                        <td>:</td>
                        <td><?= $data['tempat_perceraian'] ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="padding:5px"></td>
                    </tr>
