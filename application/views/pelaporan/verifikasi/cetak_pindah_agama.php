    ...
    <body>
        <div id="container">
            ...
            <table>
                    ...
                    <tr>
                        <th>II.</th>
                        <th colspan="2">AGAMA LAMA</th>
                    </tr>
                    <tr>
                        <td></td>
                        <td>1.&nbsp;&nbsp;Agama</td>
                        <td>:</td>
                        <td><?= $data['agama_lama'] ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="padding:5px"></td>
                    </tr>
                    <tr>
                        <th>III.</th>
                        <th colspan="2">AGAMA BARU</th>
                    </tr>
                    <tr>
                        <td></td>
                        <td>1.&nbsp;&nbsp;Agama</td>
                        <td>:</td>
                        <td><?= $data['agama_baru'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>2.&nbsp;&nbsp;Tanggal Perpindahan</td>
                        <td>:</td>
                        <td><?= tanggal_indonesia($data['tanggal_pindah']) ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="padding:5px"></td>
                    </tr>
