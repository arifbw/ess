        ...
        <div id="container">
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <small><?= '('.$data['jenis_alamat_lama'].') '.$data['alamat_lama'].', '.$data['kelurahan_lama'].', '.$data['kecamatan_lama'].', '.$data['kabupaten_lama'].', '.$data['provinsi_lama'] ?></small>
                            <br>
                            <small><?= $data['kode_pos_lama'] ?></small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" style="padding:5px"></td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <small><?= '('.$data['jenis_alamat_baru'].') '.$data['alamat_baru'].', '.$data['kelurahan_baru'].', '.$data['kecamatan_baru'].', '.$data['kabupaten_baru'].', '.$data['provinsi_baru'] ?></small>
                            <br>
                            <small><?= $data['kode_pos_baru'] ?></small>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4" style="padding:5px"></td>
