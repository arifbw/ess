            ...
            <div id="body">
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><?= $data['tempat_lahir_suami'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>3.&nbsp;&nbsp;Tanggal Lahir</td>
                        <td>:</td>
                        <td><?= tanggal_indonesia($data['tanggal_lahir_suami']) ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>4.&nbsp;&nbsp;Status Pekerjaan</td>
                        <td>:</td>
                        <td><?= $data['status_pekerjaan'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>5.&nbsp;&nbsp;Nama Instansi</td>
                        <td>:</td>
                        <td><?= $data['nama_instansi'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>6.&nbsp;&nbsp;Nomor Telpon Instansi</td>
                        <td>:</td>
                        <td><?= $data['telpon_instansi'] ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>7.&nbsp;&nbsp;No Surat Keterangan<br>Tidak Mendapat Fasilitas Kesehatan</td>
                        <td>:</td>
