		...
		<div id="page-wrapper">
			<div class="container-fluid">
                ...
                if(@$akses["persetujuan"] || @$akses["submit"]) { ?>
                <!-- Modal -->
		...
		<script type="text/javascript">
			...
			function table_serverside()
			{
				...
				table = $('#daftar_pendidikan').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url("pelaporan/verifikasi/pendidikan/tabel_pendidikan/")?>",
						"data":{
							'status': $("#status").val()
						},
						"type": "POST",
			...
			function export_excel(){
				...
				$.ajax({
					url: '<?= base_url('pelaporan/verifikasi/export/pendidikan/excel') ?>',
					type: 'GET',
					dataType: 'JSON',
					data: filter,
		...
		<script>
			$(document).on('click','.detail_button',function(e){
	            ...
	            $.post('<?php echo site_url("pelaporan/verifikasi/pendidikan/view_detail") ?>',
	        ...
	        $(document).on('click','.persetujuan_button',function(e){
	            ...
	            $.post('<?php echo site_url("pelaporan/verifikasi/pendidikan/view_approve") ?>',
	                {id_:$(this).attr('data-id')},
	                function(e){
	                    $(".set-approve").html(e);
	                }
