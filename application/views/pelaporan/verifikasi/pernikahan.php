...
<script type="text/javascript">
	...
	function table_serverside() {
		...
		table = $('#daftar_pernikahan').DataTable({
			...
			ajax: {
				url: "<?= site_url("pelaporan/verifikasi/pernikahan/tabel_pernikahan/")?>",
				data:{
					status: $("#status").val()
				},
				type: "POST",
	...
	function export_excel(){
		...
		$.ajax({
			url: '<?= base_url('pelaporan/verifikasi/export/pernikahan/excel') ?>',
			type: 'GET',
			dataType: 'JSON',
			data: filter,
...
<script>
	$(document).on('click','.detail_button',function(e){
		...
		$.post('<?= site_url("pelaporan/verifikasi/pernikahan/view_detail") ?>',
	...
	$(document).on('click','.persetujuan_button',function(e){
		...
		$.post('<?= site_url("pelaporan/verifikasi/pernikahan/view_approve") ?>',
			{id_:$(this).attr('data-id')},
			function(e){
				$(".set-approve").html(e);
			}
