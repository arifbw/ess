...
<script type="text/javascript">
	...
	function table_serverside() {
		...
		table = $('#daftar_suami_tertanggung').DataTable({ 
			...
			ajax: {
				url: "<?= site_url("pelaporan/verifikasi/suami_tertanggung/tabel_suami_tertanggung/")?>",
				data:{
					status: $("#status").val()
				},
				type: "POST",
	...
	function export_excel(){
		...
		$.ajax({
			url: '<?= base_url('pelaporan/verifikasi/export/suami_tertanggung/excel') ?>',
			type: 'GET',
			dataType: 'JSON',
			data: filter,
...
<script>
	$(document).on('click','.detail_button',function(e){
		...
		$.post('<?= site_url("pelaporan/verifikasi/suami_tertanggung/view_detail") ?>',
	...
	$(document).on('click','.persetujuan_button',function(e){
		...
		$.post('<?= site_url("pelaporan/verifikasi/suami_tertanggung/view_approve") ?>',
			{id_:$(this).attr('data-id')},
			function(e){
				$(".set-approve").html(e);
			}
