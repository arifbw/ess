                        ...
                        <div class="form-group">
							<div class="row">
								...
								<?php if (@$akses["persetujuan"]) { ?>
									<div class="col-md-2">
										<br>
										<button class="btn btn-success btn-md" data-toggle='modal' data-target='#modal_approve_all'">Setujui Semua Pelatihan</button>
									</div>
								<?php } ?>
						...
						<div class="modal fade" id="modal_persetujuan" tabindex="-1" role="dialog" aria-labelledby="label_modal_status" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
										...
										<div class="modal-body">		
											<form role="form" action="<?php echo base_url(); ?>pelatihan/persetujuan_pelatihan/action_persetujuan_pelatihan" id="formulir_tambah" method="post">	
											...
											<div class="alert alert-info">
												...
												<div class="form-group" style="margin-left: 15px; margin-right: 15px;">
													...
													<div class="row">
														...
														<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_ess_riwayat_pelatihan">
															<thead>
																<tr>
																	<th class='text-center'>No</th>
																	<th class='text-center'>NP</th>
		...
		<script type="text/javascript">
			...
			function table_serverside()
			{
				...
				table = $('#tabel_ess_pelatihan').DataTable({ 
					...
					"ajax": {
							"url": "<?php echo site_url('pelatihan/persetujuan_pelatihan/tabel_ess_pelatihan/')?>" + bulan_tahun + "/" + filter,
							"type": "POST",
						},
					...
					"columnDefs": [
						...
						{ 
							"targets": [0,1,4,5], //first column / numbering column
