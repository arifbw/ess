									          	...
									          	<div class="modal-content">
													...
													<div class="modal-body">
														...
														<select multiple="multiple" class="form-control select2" id="multi_select" name='np_karyawan[]' style="width: 100%;" required>
															...
															<?php foreach ($array_daftar_karyawan as $val) { ?>
											...
											<div class="form-group row">
												...
												<div class="col-lg-10">
													<select class="form-control select2insidemodal" name="edit_np_karyawan" id="edit_np_karyawan" style="width: 100%" required>
                                                        <option value=''></option>
                                                        <?php 
                                                        foreach ($array_daftar_karyawan as $value) {		
                                                        ?>
		...
		<script type="text/javascript">
			...
			function table_serverside()
			{
				...
				table = $('#tabel_data_perizinan').DataTable({ 
					...
					"ajax": {
						"url": "<?php echo site_url("perizinan/Data_perizinan/tabel_data_perizinan/")?>"+ bulan_tahun + '/' + izin_0 + '/' + izin_C + '/' + izin_E + '/' + izin_F + '/' + izin_G + '/' + izin_H + '/' + izin_SIPK ,
						"type": "POST",
                        //data: data_save
					},
