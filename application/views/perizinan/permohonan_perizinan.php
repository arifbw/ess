        					...
        					<div class="col-md-3">
        						...
        						<div class="modal fade" id="show_otoritas" srole="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        							<div class="modal-dialog modal-md" role="document">
        								<form method="post" target="_blank" action="<?php echo base_url('perizinan/permohonan_perizinan/cetak') ?>">
        									<div class="modal-content">
        										<div class="modal-header">
        											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												...
												<input type="hidden" name="bulan" value="" id="get_month" />
														...
														<input type="hidden" name="izin_SIPK" value="" id="izin_SIPK" />
		...
		<script type="text/javascript">
        	...
        	function table_serverside() {
        		...
        		table = $('#permohonan_perizinan').DataTable({
        			...
        			"iDisplayLength": 10,
        			"language": {
        				"url": "/asset/datatables/Indonesian.json",
        			...
        			//push
        			"ajax": {
        				"url": "<?php echo base_url("perizinan/permohonan_perizinan/permohonan_perizinan/") ?>" bulan_tahun + '/' + izin_0 + '/' + izin_C + '/' + izin_E + '/' + izin_F + '/' + izin_G + '/' + izin_H + '/' + '1',
        				"type": "POST",
        				data: {
