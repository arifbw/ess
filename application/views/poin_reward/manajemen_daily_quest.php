		...
		<div id="page-wrapper">
			<div class="container-fluid">
										...
										<div class="panel-body">
											<form role="form" action="" id="formulir_tambah" method="post" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="form-group">
														<div class="col-lg-2">
															<label>Poin Harian</label>
														</div>
														<div class="col-lg-7">
															<input class="form-control" type="number" name="poin_harian" value="<?php echo $poin_harian;?>" placeholder="Poin Harian">
														</div>
														<div id="warning_poin_harian" class="col-lg-3 text-danger"></div>
													</div>
												</div>
												<div class="row">
													<div class="form-group">
				...
				?>
						<div class="row">
							<table width="100%" class="table table-striped table-bordered table-hover" id="tabel_manajemen_daily_quest">
								<thead>
									<tr>
										...
										<th class='text-center'>Jumlah Klaim Hari Ini</th>
										<?php
								...
								<tbody>
									<?php
										for($i=0;$i<count($daftar_manajemen_daily_quest);$i++){
											if($i%2==0){
												$class = "even";
											}
											else{
											...
											echo "<tr class='$class'>";
												// echo "<td align='center'><img src=".base_url()."uploads/images/daily_quest/".$daftar_manajemen_daily_quest[$i]["gambar"]." style='width: 100%; max-height: 150px;' alt='Gambar Belum Diupload'></td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["nama"]."</td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["poin"]."</td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["poin_harian"]."</td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["start_date"]."</td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["end_date"]."</td>";
												echo "<td class='text-center'>";
													if((int)$daftar_manajemen_daily_quest[$i]["status"]==1){
														echo "Aktif";
													}
													else if((int)$daftar_manajemen_daily_quest[$i]["status"]==0){
														echo "Non Aktif";
													}
												echo "</td>";
												echo "<td align='center'>".$daftar_manajemen_daily_quest[$i]["jumlah_klaim"]."</td>";
												if($akses["ubah"] or $akses["riwayat"]){
													echo "<td class='text-center'>";
														if($akses["ubah"]){
														...
														if ($akses["riwayat"]) {
															echo "<a href='".base_url($url_riwayat)."/".$daftar_manajemen_daily_quest[$i]["created_by_np"]."/".$daftar_manajemen_daily_quest[$i]["nama"]."' class='btn btn-primary btn-xs'>Riwayat</a> ";
														}
													echo "</td>";
												}
											echo "</tr>";
										...
										<div class="modal-body">
											...
											<div class="row">
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input type="hidden" name="poin_harian" value="">
														<input class="form-control" type="number" name="poin_harian_ubah" value="" placeholder="Poin Harian">
													</div>
													<div id="warning_poin_harian_ubah" class="col-lg-3 text-danger"></div>
												</div>
											</div>
											<div class="row">
												<div class="form-group">
