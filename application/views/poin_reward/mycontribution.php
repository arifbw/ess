                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form role="form" action="<?= base_url(); ?>poin_reward/mycontribution/action_insert_mycontribution" id="formulir_tambah" method="post" enctype="multipart/form-data">
                ...
                <?php if ($this->session->userdata('grup') != '5'): ?>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form role="form" action="<?= base_url(); ?>poin_reward/mycontribution/import_excel" id="formulir_import" method="post" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-lg-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 text-right">
                                            ...
                                            <a href="<?= base_url('poin_reward/mycontribution/create_template'); ?>" class="btn btn-info">Unduh Template</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    function table_serverside() {
        ...
        table = $('#daftar_mycontribution').DataTable({
            ...
            "ajax": {
                "url": "<?= site_url("poin_reward/mycontribution/tabel_mycontribution") ?>",
                "data": {
                    status: $("#status").val(),
...
<script>
    ...
    $(document).on('click', '.detail_button', function(e) {
        ...
        $.post('<?php echo site_url("poin_reward/mycontribution/view_detail") ?>', {
    ...
    $(document).on('click', '.hapus', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.get('<?= site_url("poin_reward/mycontribution/hapus") ?>/' + $(this).data('id') + '/' + $(this).data('np'),
                    function(get) {
                        ret = JSON.parse(get);
                        if (ret.status == true) {
                            Swal.fire(
