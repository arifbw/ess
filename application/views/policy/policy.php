<html>
    ...
    <body>
        ...
        <p>
            Perum Peruri built the ESS PERURI MOBILE app as a Free app. This SERVICE is
            provided by Perum Peruri at no cost and is intended for use as is.
            ...
            Conditions, which is accessible at ESS PERURI MOBILE unless otherwise defined in
            this Privacy Policy.
        </p>
        <p>
            <b>Information Collection and Use</b><br>
            For a better experience, while using our Service, we may require you to provide us
            with certain personally identifiable information, including but not limited to Location
            Permission, File Permission, Camera Permission. The information that we request will
            ...
            <ul><li><a href="https://www.google.com/policies/privacy/">Google Play Services</a></li></ul>
        ...
        <p>
            ...
            contact us at <a href="mailto:it.solution@peruri.co.id">it.solution@peruri.co.id</a>
        </p>
        ...
        <p>
            ...
            intellectual property rights related to it, still belong to Perum Peruri.
        </p>
        <p>
            Perum Peruri is committed to ensuring that the app is as useful and efficient as
        ...
        <p>
            The ESS PERURI MOBILE app stores and processes personal data that you have
            provided to us, in order to provide our Service. It’s your responsibility to keep your
            ...
            your phone’s security features and it could mean that the ESS PERURI MOBILE app
        ...
        <p>
            You should be aware that there are certain things that Perum Peruri will not take
            responsibility for. Certain functions of the app will require the app to have an active
            internet connection. The connection can be Wi-Fi, or provided by your mobile
            network provider, but Perum Peruri cannot take responsibility for the app not
        ...
        <p>
            ...
            the connection while accessing the app, or other third party charges. In using the
            app, you’re accepting responsibility for any such charges, including roaming data
            charges if you use the app outside of your home territory (i.e. region or country)
            without turning off data roaming. If you are not the bill payer for the device on which
            you’re using the app, please be aware that we assume that you have received
            permission from the bill payer for using the app.
        </p>
        <p>
            Along the same lines, Perum Peruri cannot always take responsibility for the way you
            use the app i.e. You need to make sure that your device stays charged – if it runs out 
            of battery and you can’t turn it on to avail the Service, Perum Peruri cannot accept
            responsibility.
        </p>
        <p>
            With respect to Perum Peruri’s responsibility for your use of the app, when you’re
            using the app, it’s important to bear in mind that although we endeavour to ensure
            that it is updated and correct at all times, we do rely on third parties to provide
            information to us so that we can make it available to you. Perum Peruri accepts no
        ...
        <p>
            ...
            updates if you want to keep using the app. Perum Peruri does not promise that it will
        ...
        <p>
            ...
            to review this page periodically for any changes. We will notify you of any changes by
        ...
        <p>
            ...
            hesitate to contact us at it.solution@peruri.co.id
        </p>
    </body>
</html>