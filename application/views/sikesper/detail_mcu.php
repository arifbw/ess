		...
		<table width="100%" class="table table-bordered table-hover" id="tabel_mcu">
			<tbody>
				...
				<tr>
					...
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->kolestrol ?></span></td>
					<th class='text-center no-sort'>GULA DARAH</th>
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->gula_darah ?></span></td>
				</tr>
				<tr>
					<th class='text-center no-sort'>ASAM URAT</th>
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->asam_urat ?></span></td>
					<th class='text-center no-sort'>MASSA LEMAK</th>
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->massa_lemak ?></span></td>
				</tr>
				<tr>
					<th class='text-center no-sort'>KLASIFIKASI TUBUH</th>
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->klasifikasi_tubuh ?></span></td>
					<th class='text-center no-sort'>KELUHAN SAAT INI</th>
					<td class='text-center no-sort' style="text-align:left"><span style="font-size:12px;"><?= $data->keluhan_saat_ini ?></span></td>
				</tr>
				<tr>
