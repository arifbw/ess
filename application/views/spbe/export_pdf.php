...
<page orientation="portrait" format="F4" backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
	...
	<div class="head-logo">
		<table>
			<tbody>
				<tr>
					<td style="width: 100%;">
						<h5 class="no-pdf mb-3 text-center">No. <?= $nomor_surat?></h5>
					</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="table-info" style="margin-bottom: 5px;">
		<table class="table table-reason">
			<tbody>
				<tr>
					<td style="width: 80%; border-right: 1px solid #000;"></td>
					<td style="width: 18%; border: 1px solid #000;">
						<h6 class="text-center">
							<?php
							switch ($barang_kembali) {
								case '1':
									echo 'KEMBALI/<del>TIDAK KEMBALI</del>*)';
									break;
								default:
									echo '<del>KEMBALI</del>/TIDAK KEMBALI*)';
									break;
							}
							?>
						</h6>
				...
				<tr>
					<td style="width: 80%; border-right: 1px solid #000;"></td>
					<td style="width: 18%; border: 1px solid #000;">
						<h6 class="text-center">TGL: <?= @$last_masuk['tanggal'] ? tanggal_indonesia($last_masuk['tanggal']):'..............................'?></h6>
					</td>
				</tr>
			</tbody>
		</table>
				...
				<tr>
					...
					<td style="width: 28%;">
						<div class="head-title text-center">
							<span>Surat Pengantar Barang <br> Ekstern</span>
						</div>
					</td>
		...
		<table class="table table-reason">
			<tbody>
				...
				<tr>
					...
					<td style="width: 38.334%"></td>
					<td style="width: 28.334%">
						<h5 class="text-center">KADEP / KADIV / DIR *)</h5>
					</td>
				</tr>
				<tr>
					<td style="width: 33.334%">
				...
				<tr>
					...
					<td style="padding-top: 10px; width: 25%">
						<div class="text-center">
							...
							<?php
							if(@$pilih_pengawal=='3'){
								echo "<h5>(Pembawa Barang: {$nama_pembawa_barang})</h5>";
							}
							?>
	...
	<div class="checking-info" style="margin-bottom: 5px;">
		<h5>2. Pemeriksaan waktu kembali Perusahaan.</h5>
		<table class="table table-checking">
			<tbody>
				<tr>
					<td style="padding-top: 5px; width: 25%">
