	...
	<div class="head-logo">
		<table>
			<tbody>
				<tr>
					<td style="width: 100%;">
						<h5 class="no-pdf mb-3 text-center">No. 005462</h5>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<tr>
					...
					<td style="width: 18%; border: 1px solid #000;">
						<h6 class="text-center">KEMBALI/<del>TIDAK KEMBALI</del>*)</h6>
					</td>
				</tr>
				<tr>
					<td style="width: 80%; border-right: 1px solid #000;"></td>
					<td style="width: 18%; border: 1px solid #000;">
						<h6 class="text-center">TGL: ..............................</h6>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<tr>
					...
					<td style="width: 28.334%">
						<h5 class="text-center">Karawang, .............................</h5>
					</td>
				</tr>
				<tr>
					<td style="width: 33.334%">
			...
			<tbody>
				<tr>
					...
					<td colspan="2" style="padding-top: 5px; width: 50%">
						<h5 class="text-center">TELAH DICEK SESUAI / TIDAK SESUAI *)</h5>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="height: 70px; width: 25%"></td>
					<td style="height: 70px; width: 25%"></td>
				</tr>
			</tbody>
		</table>
