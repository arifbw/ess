...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbe/modal_approval_masuk_pengguna');
		}
		?>
	</div>
</div>
...
<script src="<?= base_url('asset/js/spbe/konfirmasi_masuk_pengguna/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbe/konfirmasi_masuk_pengguna/approval.js')?>"></script>
