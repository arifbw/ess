        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="alert alert-primary">
                                <div class="list-lampiran" style="display:flex;flex-wrap: wrap;">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <!-- kasek option -->
                    <div class="col-lg-12 div-approval-kasek">
                        <div class="alert alert-warning">
                            <strong>Approval Kasek</strong><br>
                            <p>NP: <span class="approval_kasek_np"></span></p>
                            <p>Nama: <span class="approval_kasek_nama"></span></p>
                            <p class="approval_kasek_status"></p>
                            <p class="approval_kasek_keterangan"></p>
                            <p class="approval_kasek_at"></p>
                        </div>
                    </div>
                    <!-- END kasek optional -->
                ...
                <hr>
                <div class="row" id="div-detail-barang-kembali">
                    <div class="col-lg-12">
                        <label>Pemeriksaan Kembali ke Perusahaan</label>
                    </div>
                    <div class="col-lg-12">
                        <div class="alert alert-warning">
...
<script src="<?= base_url('asset/js/spbe/pdf.min.js')?>"></script>
