...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbe/modal_approval_keluar_danposko');
		}
		?>
	</div>
</div>
...
<script src="<?= base_url('asset/js/spbe/pemeriksaan_keluar_danposko/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbe/pemeriksaan_keluar_danposko/approval.js')?>"></script>
