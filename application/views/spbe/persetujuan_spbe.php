...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<table width="100%" class="table table-striped table-bordered table-hover" id="persetujuan_spbe">
					<thead>
						<tr>
		...
		$this->load->view('spbe/modal_approval_atasan');
...
<script src="<?= base_url('asset/js/spbe/persetujuan_spbe/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbe/persetujuan_spbe/approval_atasan.js')?>"></script>
