...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbi/modal_approval_keluar_pengawal');
		}
		?>
	</div>
</div>
...
<script src="<?= base_url('asset/js/spbi/konfirmasi_keluar_pengawal/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/konfirmasi_keluar_pengawal/approval.js')?>"></script>
