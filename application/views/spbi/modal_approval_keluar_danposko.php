    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="label-modal-approval">Pemeriksaan waktu keluar perusahaan: Dan / Wadan Posko</h4>
            </div>
                    ...
                    <div class="col-12 alert alert-success">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-control" name="danposko_status" required>
                        ...
                        <div class="row div-keterangan" style="display: none;">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <label>Alasan</label>
                                    <input type="text" class="form-control" name="danposko_keterangan">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <label>Tanggal</label>
                                    <input type="date" class="form-control" name="danposko_tanggal" value="<?= date('Y-m-d')?>" required>
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <label>Jam</label>
                                    <input type="time" class="form-control" name="danposko_jam" value="<?= date('H:i')?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
