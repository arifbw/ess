...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbi/modal_approval_keluar_admin_pamsiknilmat');
...
<script src="<?= base_url('asset/js/spbi/pemeriksaan_keluar_admin_pamsiknilmat/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/pemeriksaan_keluar_admin_pamsiknilmat/approval.js')?>"></script>
