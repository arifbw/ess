...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbi/modal_approval_keluar_petugas_pamsiknilmat');
		}
		?>
	</div>
</div>
...
<script src="<?= base_url('asset/js/spbi/pengecekan_keluar_petugas_pamsiknilmat/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/pengecekan_keluar_petugas_pamsiknilmat/approval.js')?>"></script>
