...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		$this->load->view('spbi/modal_approval_masuk_petugas_pamsiknilmat');
...
<script src="<?= base_url('asset/js/spbi/pengecekan_masuk_petugas_pamsiknilmat/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/pengecekan_masuk_petugas_pamsiknilmat/approval.js')?>"></script>
