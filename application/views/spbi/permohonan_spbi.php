...
<div id="page-wrapper">
	<div class="container-fluid">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="<?= base_url('spbi/permohonan_spbi/tambah')?>">Tambah <?php echo $judul;?></a>
						</h4>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<table width="100%" class="table table-striped table-bordered table-hover" id="permohonan_spbi">
					<thead>
						<tr>
...
<script src="<?= base_url('asset/js/spbi/permohonan_spbi/index.js')?>"></script>
