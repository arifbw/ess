...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<table width="100%" class="table table-striped table-bordered table-hover" id="persetujuan_spbi">
					<thead>
						<tr>
		...
		<?php
		$this->load->view('spbi/modal_detail_spbi');
		$this->load->view('spbi/modal_approval_atasan');
		$this->load->view('spbi/modal_pilih_lokasi');
		}
		?>
	</div>
</div>
...
<script src="<?= base_url('asset/js/spbi/persetujuan_spbi/index.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/persetujuan_spbi/approval_atasan.js')?>"></script>
<script src="<?= base_url('asset/js/spbi/detail.js')?>"></script>
