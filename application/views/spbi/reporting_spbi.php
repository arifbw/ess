...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<table width="100%" class="table table-striped table-bordered table-hover" id="reporting_spbi">
					<thead>
						<tr>
							...
							<th class="text-center" style="width: 20%">Posisi Barang</th>
...
<script src="<?= base_url('asset/js/spbi/reporting_spbi/index.js')?>"></script>
