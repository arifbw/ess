...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel">
					<a href="<?= base_url('spbi/permohonan_spbi')?>" class="btn btn-default">Back</a>
				</div>
			</div>
		</div>
		<?php
			...
			<div class="col-lg-12">
				<form role="form" action="#" id="formulir_tambah" method="post" onsubmit="return false;">
					...
					<div class="row">
						<div class="form-group">
							<div class="col-lg-3">
								<label>Atasan Minimal Kasek</label>
							</div>
							<div class="col-lg-6">
...
<script src="<?= base_url('asset/js/spbi/permohonan_spbi/tambah.js')?>"></script>
