...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="alert alert-info">
			Batas submit tanggal <strong>31 Agustus 2021 Pukul 17:00 WIB</strong><br>
...
<script type="text/javascript">
	...
	const doUbah = () => {
		...
		if( $('input[name=ubah_status_vaksin]:checked').val()==undefined ){
			...
			var r = confirm("Perhatian!\nAnda hanya bisa melakukan submit sebelum masa cut off pada 10 September 2021. Pastikan isian Anda sudah benar.\nLanjutkan?");
			if (r == true) {
