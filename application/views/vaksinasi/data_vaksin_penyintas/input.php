...
<form role="form" id="formulir-ubah" method="post" onsubmit="return false;">
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-lg-4">
                <label>Tanggal PCR Negatif<code>*</code></label>
            </div>
            <div class="col-lg-8">
                <input type="date" class="form-control" name="ubah_tanggal_pcr_negatif" id="ubah_tanggal_pcr_negatif" placeholder="Tanggal PCR Negatif" onchange="checkDate()" required>
            </div>
        </div>
    </div>
