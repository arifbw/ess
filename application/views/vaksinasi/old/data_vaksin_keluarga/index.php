...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="alert alert-info">
			Sesuai kebijakaan yang berlaku vaksin keluarga hanya untuk usia tanggungan <strong>minimal 18 Tahun</strong>
		</div>
...
<script type="text/javascript">
				...
				},
				{
					render: (data, type, row) => {
						...
						if(jQuery.inArray(sessionGroup, ['4','5']) !== -1){
							if( (2021 - parseInt(moment(row.tanggal_lahir).format('YYYY'))) > 17 && ( moment(d).format('YYYY-MM-DD') < moment('2021-07-10').format('YYYY-MM-DD') ) ){
								const input = $('<button/>', {
									html: 'Input',
	...
	const input = async (data) => {
		console.log(data);
		let fields = ['np_karyawan','nama_karyawan','tipe_keluarga','nama_lengkap','usia','tanggal_lahir','nik','email','no_hp','alamat','status_kawin','tempat_lahir_keluarga'];
