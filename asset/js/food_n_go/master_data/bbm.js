function cek_simpan_tambah(){
	...
	if(formulir["nama"].value == ""){
		...
		document.getElementById("warning_nama").innerHTML = "Nama BBM harus diisi.";
	}
	else{
		document.getElementById("warning_nama").innerHTML = "";
	}
	
	if(formulir["harga"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_harga").innerHTML = "Harga BBM harus diisi.";
	}
	else{
		document.getElementById("warning_harga").innerHTML = "";
	}
...
function cek_simpan_ubah(){
	...
	if(formulir["nama_ubah"].value == ""){
		...
		document.getElementById("warning_nama_ubah").innerHTML = "Nama BBM harus diisi.";
	}
	else{
		document.getElementById("warning_nama_ubah").innerHTML = "";
	}
	
	if(formulir["harga_ubah"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_harga_ubah").innerHTML = "Harga BBM harus diisi.";
	}
	else{
		document.getElementById("warning_harga_ubah").innerHTML = "";
	}
...
/*function tampil_data_ubah(element){
	...
	formulir["harga"].value = element.parentNode.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["harga_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.innerHTML;
