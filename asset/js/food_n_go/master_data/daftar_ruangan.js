function cek_simpan_tambah(){
	...
	if(formulir["nama"].value == ""){
		...
		document.getElementById("warning_nama").innerHTML = "Nama ruangan harus diisi.";
	}
	else{
...
//		ruangan		document.getElementById("warning_nama_ubah").innerHTML = "Nama ruangan harus diisi.";
	}
	else{
...
function tampil_data_ubah_new(element){
    ...
    $('#kapasitas_ubah').val(element.dataset.kapasitas); // heru menambahkan ini 2020-11-25 @12:00
