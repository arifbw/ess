function cek_simpan_tambah(){
	...
	if(formulir["nama"].value == ""){
		...
		document.getElementById("warning_nama").innerHTML = "Nama Attendance harus diisi.";
	}
	else{
...
function cek_simpan_ubah(){
	...
	if(formulir["nama_ubah"].value == ""){
		...
		document.getElementById("warning_nama_ubah").innerHTML = "Nama Attendance harus diisi.";
	}
	else{
...
function processAjax(report,params){
	if(report=="ubah"){
		url = "master_data/ajax/attendance/ubah/";
	}
	else{
		url = "";
	}
