...
function processAjax(report,params){
	if(report=="salin_tambah"){
		url = "master_data/ajax/jadwal_kerja/salin/";
	}
	else if(report=="ubah"){
		url = "master_data/ajax/jadwal_kerja/ubah/";
	}
	else{
		url = "";
	}
...
function ubah(element){
	var id_jadwal_kerja = element.previousSibling.value;
	processAjax("ubah",id_jadwal_kerja);
}
