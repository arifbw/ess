function cek_simpan_tambah(){
	...
	if(formulir["nama"].value == ""){
		...
		document.getElementById("warning_nama").innerHTML = "Nama pos harus diisi.";
	}
	else{
		document.getElementById("warning_nama").innerHTML = "";
	}
	
	if(formulir["kode_pos"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_kode_pos").innerHTML = "Kode pos harus diisi.";
	}
	else{
		document.getElementById("warning_kode_pos").innerHTML = "";
	}
...
function cek_simpan_ubah(){
	...
	if(formulir["nama_ubah"].value == ""){
		...
		document.getElementById("warning_nama_ubah").innerHTML = "Nama pos harus diisi.";
	}
	else{
		document.getElementById("warning_nama_ubah").innerHTML = "";
	}
	
	if(formulir["kode_pos_ubah"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_kode_pos_ubah").innerHTML = "Kode pos harus diisi.";
	}
	else{
		document.getElementById("warning_kode_pos_ubah").innerHTML = "";
	}
...
function tampil_data_ubah(element){
	...
	formulir["kode_pos"].value = element.parentNode.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["kode_pos_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.innerHTML;
