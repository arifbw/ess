function cek_simpan_tambah(){
	...
	if(formulir["poin_harian"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_poin_harian").innerHTML = "Poin Harian harus diisi.";
	}
	else{
		document.getElementById("warning_poin_harian").innerHTML = "";
	}
...
function cek_simpan_ubah(){
	...
	if(formulir["poin_harian_ubah"].value == ""){
		if(lanjut){
			lanjut = false;
		}
		document.getElementById("warning_poin_harian_ubah").innerHTML = "Poin Harian harus diisi.";
	}
	else{
		document.getElementById("warning_poin_harian_ubah").innerHTML = "";
	}
...
function tampil_data_ubah(element){
	...
	formulir["poin_harian"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["poin_harian_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
