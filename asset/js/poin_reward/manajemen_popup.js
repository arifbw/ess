...
function tampil_data_ubah(element) {
	...
	formulir["nama"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["nama_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;

	formulir["link"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["link_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;

	formulir["poin"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
	formulir["poin_ubah"].value = element.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerHTML;
...
function checkPhoto(target) {
	...
	checkAspectRatio(target.files[0], "warning_gambar");
	if (document.getElementById("warning_gambar").innerHTML != "") {
		return false;
	}
	return true;
...
function checkPhotoUbah(target) {
	...
	checkAspectRatio(target.files[0], "warning_gambar_ubah");
	if (document.getElementById("warning_gambar_ubah").innerHTML != "") {
		return false;
	}
	return true;
...
function checkAspectRatio(val, elementId) {
	...
	reader.onload = function (e) {
		...
		image.onload = function () {
			...
			if (aspectRatio > 0.75) {
				document.getElementById(elementId).innerHTML = "Rasio ukuran file tidak sesuai " + aspectRatio.toFixed(2) + " > maks 0.75 (Portrait 3:4)";
			}
			return true;
		};
	};
