...
function table_serverside() {
    ...
    table_spbe = $('#reporting_spbe').DataTable({ 
        destroy: true,
        iDisplayLength: 10,
        language: {
        ...
        ordering: false,
        ajax: {
            url: `${BASE_URL}spbe/reporting_spbe/get_data_reporting`,
            type: "POST",
...
const export_excel = ()=>{
    ...
    let start_date = date_range_array[0];
    let end_date = date_range_array[1];
    window.open(`${BASE_URL}spbe/Export_excel/generate?start_date=${start_date}&end_date=${end_date}`,'_blank');
}
...
const export_row = (data)=>{
    ...
    let start_date = date_range_array[0];
    let end_date = date_range_array[1];
    window.open(`${BASE_URL}spbe/Export_excel/generate?start_date=${start_date}&end_date=${end_date}&id=${data.uuid}`,'_blank');
}