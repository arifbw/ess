...
function table_serverside() {
    ...
    table_spbi = $('#table-data').DataTable({ 
        ...
        ordering: false,
        ajax: {
            url: `${BASE_URL}spbi/pengecekan_keluar_petugas_pamsiknilmat/get_data_persetujuan`,
            type: "POST",
        ...
        columns: [
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                    ...
                    if( row.pengecek1_status===null && row.konfirmasi_pengguna!='2' && row.danposko_status!='2' ){
                        let approval = $('<button/>', {
                            html: 'Persetujuan',
